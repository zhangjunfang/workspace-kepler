#ifndef _SF_TCP_CLIENT_
#define _SF_TCP_CLIENT_ 1
...
class TcpClient : public BaseClient , public ITcpClient
{
	// 环境指针
	ISystemEnv  *	_pEnv ;
	// 接收线程数
...
public:
	...
	// 增加连接通道
	virtual bool AddChannel(ITcpServer *svr, const string &userid, const char *ip, int port);
	// 删除连接通道
