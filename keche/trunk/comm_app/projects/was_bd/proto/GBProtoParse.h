...
struct BatchLocationItem {
	unsigned short len;
	unsigned char dat[0];
};

struct BatchLocationHead {
	unsigned short size;
	unsigned char type;
};
...
struct TakePhotoReply {
	GBheader header;
	unsigned short ackid;
	unsigned char result;
	unsigned short count;
	unsigned int   mmids[0];
};

struct TermUpdateReply {
	unsigned char type;
	unsigned char result;
};

struct RemoteCtrlCarParam {
	unsigned char action;
	unsigned char channel;
	unsigned short maxrpm;
	unsigned char locktime[6];
	unsigned char warntime[6];
	unsigned char status;
};

struct RemoteCtrlCarLockReply {
	unsigned char result;
	char code[6];
};

struct RemoteCtrlCarReply {
	GBheader header;
	unsigned short ackseq;
	unsigned short method;
};

struct RemoteCtrlCarReport {
	GBheader header;
	unsigned char status;
	GpsInfo gbsinfo;
	GBFooter footer;
