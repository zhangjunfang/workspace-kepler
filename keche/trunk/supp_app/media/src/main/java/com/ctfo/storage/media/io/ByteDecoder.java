...
//                        		消息应答
                        		...
                        		response.append(str.substring(10,18))
                        		.append(str.substring(2,10)).append("1001")
                        		.append(Tools.fillNBitBefore(Integer.toHexString(SerialUtil.getInt()), 8, "0"))
                        		.append("00000005").append(str.substring(22,30)).append("00");
                        		response.append(Tools.getCheckCode(response.toString())).append("5D");
                        		String res = Tools.getReverTransferContent("5B"+response.toString());             	
                        		session.write(res);
                        	}
                        }
                    } finally {
