...
if [ "$LBS_HOME" = "" ]; then
	LBS_HOME="/home/zjhl/supp_app"
fi

DATE_STRING="$(date +'%Y-%m-%d-%H-%M')"
JAVACMD="$JAVA_HOME/bin/java"
CLASS_HOME=""
SERVICE_CLASS="com.ctfo.storage.media.core.MediaMain"
...
unset CLASSPATH
for i in ${LBS_HOME}/media/lib/*.jar ; do
  if [ "$CLASSPATH" != "" ]; then
...
LOGBACK=${LBS_HOME}/media/conf/logback.xml
...
JVM_LOG_DIR="/home/zjhl/supp_app/media/logs/"
