...
public class Tools {
	...
	public static String getTransferContent(String message){
		...
		String msgContent = "";
		String checkCode = message.substring(message.length()-4,message.length()).toUpperCase();
		msgContent = message.substring(2,message.length()-4).toUpperCase();
		...
		if(!eds.equals("5A01") &&  !eds.equals("5A02") && !eds.equals("5E01") && !eds.equals("5E01")){
			buffer.append(msgContent.substring(msgContent.length()-2,msgContent.length()));
		}
		
		return "5B"+buffer.toString().toUpperCase()+checkCode;
	}
	/**
...
//        return temp.toString().substring(0,1).equalsIgnoreCase("0")?temp.toString().substring(1):temp.toString();
   ...
   public static byte[] str2Bcd(String asc) {
	...
	public static void main(String[] args) {
		System.out.println(getCheckCode("57c5d80a05397fb1110000000002000000081104020212071208"));
		...
		System.out.println(Tools.isRightDeviceCode(""));
	System.out.println(Tools.getChinese("313336343338343134353900")); 
