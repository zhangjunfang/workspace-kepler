   ...
   public static byte[] str2Bcd(String asc) {
	...
	public static boolean isRightDeviceCode(String message) {
		if(!message.toUpperCase().startsWith("5B") || !message.toUpperCase().endsWith("5D")){ 
			...
			int sign_length =0;
			try {
				sign_length = Integer.parseInt(message.substring(30,38),16);
	...
	public static void main(String[] args) {
		...
		String str = Tools.getTransferContent("5B05397FB100BC614EC00100000404000000050035F8D100B95D");
		System.out.println(str);
		System.out.println(Tools.isRightDeviceCode(str));
		System.out.println(Tools.getReverTransferContent("5B00BC614E05397FB11200015A0211860000000F120131353133363435343334390000985D"));
	}
