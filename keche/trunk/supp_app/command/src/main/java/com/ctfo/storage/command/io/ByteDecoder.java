...
import com.ctfo.storage.command.model.ResponseModel;
...
//                		String content = Tools.bytesToHexStr(data);// 
...
//                        String str = new String(buffer.array());
                        ...
                        String str = Tools.bytesToHexStr(data) + "5D";//
                        //log.info("收到:"+str);
                        if(str != null){
...
//		System.arraycopy(in.array(), 0, buffer, 0, in.limit());
//		String content = Tools.bytesToHexStr(buffer);// 澧炲姞浜岃繘鍒惰浆16杩涘埗瀛楃涓�
//		out.write(content);
