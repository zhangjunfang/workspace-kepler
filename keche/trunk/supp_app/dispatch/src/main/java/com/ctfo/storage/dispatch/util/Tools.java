...
public class Tools {
	...
	public static String getCheckCode(String str){
		...
		messageCheck = Integer.toHexString(pre).toUpperCase();
	...
	public static String getTransferContent(String message){
		...
		String msgContent = "";
		msgContent = message.substring(2,message.length()-2).toUpperCase();
		for(int i=0;i<msgContent.length()/2-1;i++){
			String pos = msgContent.substring(i*2,(i+1)*2);
			String end = msgContent.substring((i+1)*2,(i+2)*2);
			if(pos.equals("5A")){
				if(end.equals("01")){
					i++;				
					buffer.append("5B");
				}else if(end.equals("02")){
					i++;				
					buffer.append("5A");
				}else {
					buffer.append(pos);				
		...
		String eds = msgContent.substring(msgContent.length()-4,msgContent.length());
		if(!eds.equals("5A01") &&  !eds.equals("5A02") && !eds.equals("5E01") && !eds.equals("5E02")){
			buffer.append(msgContent.substring(msgContent.length()-2,msgContent.length()));
		}
		
		return "5B"+buffer.toString().toUpperCase()+"5D";
	}
	 ...
	 * @return
	 */
	public static String getReverTransferContent(String message){
		StringBuffer buffer = new StringBuffer();
		String msgContent = "";
		msgContent = message.substring(2,message.length()-2).toUpperCase();
		for(int i=0;i<msgContent.length()/2;i++){
			...
			if(pos.equals("5B")){
				buffer.append("5A01");		
			}else if(pos.equals("5A")){
				buffer.append("5A02");	
			}else if(pos.equals("5D")){
				buffer.append("5E01");	
			}else if(pos.equals("5E")){
				buffer.append("5E02");	
			}else {
     ...
     * @return
     */
    public static String getStringByBytes(byte[] byteArray){
    	try {
...
//        return temp.toString().substring(0,1).equalsIgnoreCase("0")?temp.toString().substring(1):temp.toString();
   ...
   public static byte[] str2Bcd(String asc) {
	...
	public static boolean isRightDeviceCode(String message) {
		if(!message.toUpperCase().startsWith("5B") || !message.toUpperCase().endsWith("5D")){ 
			log.debug("校验错误，非5B开头5D结尾！");
			return false;
		}
		else{
			int sign_length = Integer.parseInt(message.substring(30,38),16);
			int data_length = (message.length()-42)/2;
			log.debug("指令标记长度："+sign_length);
			log.debug("实际接收长度："+data_length);
			String msgCode = message.substring(message.length()-4,message.length()-2);	
			 if(!msgCode.equals(Tools.getCheckCode(message.substring(2,message.length()-4)))){
				log.debug("校验错误，校验码错误！");
				return false;
			}else if(sign_length != data_length){
	...
	public static String getMasterType(String message){
		return message.substring(18,22);
	}
	...
	public static String getSlaveType(String message){
		return message.substring(38,42);
	}


	
	public static void main(String[] args) {
		//System.out.println(getCheckCode(""));
		//System.out.println(Tools.getASCIIByHex("6875616E670000000000000000000000"));
		//System.out.println(Integer.parseInt("05397fb1",16)); 
		//int fr = 1472583690;
		//String from = Tools.fillNBitBefore(Integer.toHexString(fr), 8, "0");
		//System.out.println(from);
		//System.out.println(getTransferContent("5b00005a445a0122555d"));
		String str = Tools.getTransferContent("");
		System.out.println(str);
		System.out.println(Tools.isRightDeviceCode(str));
		System.out.println(Tools.getCheckCode("57C5D80A05397FB110010000000a00000005000016A900"));
		System.out.println(Tools.getReverTransferContent("5B005E5D"));
		System.out.println(Tools.getChinese("",GBK));
	}
