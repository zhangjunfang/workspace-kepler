package com.ctfo.sectionspeed.util;
...
public class ResourcesUtil {
	...
	public static URL getResourceURL(final String resource, final ClassLoader loader) throws IOException {
		URL url = null;
	...
	public static InputStream getResourceAsStream(final String resource, final ClassLoader loader) throws IOException {
		...
		for (ClassLoader cl : getClassLoaders(loader)) {
			if (null != cl) {
		        ...
		        if (null == in) in = cl.getResourceAsStream("/" + resource);
	...
	public static InputStreamReader getResourceAsReader(final String resource, final ClassLoader loader) throws IOException {
	...
	public static File getResourceAsFile(final String resource, final ClassLoader loader) throws IOException {
