...
namespace HXC_FuncUtility
{
    ...
    public class GlobalStaticObj_Server
    {
        ...
        /// <summary> 会话服务名
        /// </summary>
        public const string SessionServiceName = "HXCSessionServiceWinService";//HXCSessionService
        /// <summary> 文件服务名
        /// </summary>
        public const string FileTransferServiceName = "HXCFileTransferServiceWinService";//HXCFileTransferService
        #endregion
