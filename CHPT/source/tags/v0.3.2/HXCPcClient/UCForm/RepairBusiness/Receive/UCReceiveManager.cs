    ...
    public partial class UCReceiveManager : UCBase
    {
        ...
        private void SubmitAndVerify(string strMessage,DataSources.EnumAuditStatus status)
        {
            ...
            foreach (DataGridViewRow dr in dgvRData.Rows)
            {
                ...
                if (isCheck != null && (bool)isCheck)
                {
                    ...
                    obj.cmdType = CommandType.Text;
                    Dictionary<string, ParamObj> dicParam = new Dictionary<string, ParamObj>();
                    dicParam.Add("maintain_no", new ParamObj("maintain_no", CommonUtility.GetNewNo(SYSModel.DataSources.EnumProjectType.Repair), SysDbType.VarChar, 40));//单据编号                   
                    dicParam.Add("maintain_id", new ParamObj("maintain_id", dr.Cells["maintain_id"].Value, SysDbType.VarChar, 40));//单据ID
        ...
        public void BindPageData()
        {
            try
            {
                ...
                strWhere = string.Format(" enable_flag='" + Convert.ToInt32(DataSources.EnumEnableFlag.USING).ToString() + "' and orders_source <>3 and dispatch_status='" + Convert.ToInt32(DataSources.EnumDispatchStatus.NotWork).ToString() + "'");//enable_flag 1未删除
        ...
        {
            UCReceiveManager_AddEvent(null, null);
        }
        /// <summary>
        /// 右键复制
        /// </summary>
        ...
        {
            UCReceiveManager_CopyEvent(null, null);
        }
        /// <summary>
        /// 右键删除
        /// </summary>
        ...
        {
            UCReceiveManager_DeleteEvent(null, null);
        }
        /// <summary>
        /// 右键提交
        /// </summary>
        ...
        {
            UCReceiveManager_SubmitEvent(null, null);
        }
        /// <summary>
        /// 右键审核
        /// </summary>
        ...
        {
            UCReceiveManager_VerifyEvent(null, null);
        }
        /// <summary>
        /// 右键编辑
        /// </summary>
        ...
        {
            UCReceiveManager_EditEvent(null, null);
        }
        #endregion
    }
}
