namespace HXCPcClient.UCForm.BusinessAnalysis.PurchaseReport
{
    partial class UCPurchaseDaily
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txt配件名称.Location = new System.Drawing.Point(786, 15);
            ...
            this.txt配件名称.ShowError = false;
            this.txt配件名称.Size = new System.Drawing.Size(121, 23);
            this.txt配件名称.TabIndex = 97;
            this.txt配件名称.Tag = "配件名称";
            this.txt配件名称.UseSystemPasswordChar = false;
            this.txt配件名称.Value = "";
            this.txt配件名称.VerifyCondition = null;
            this.txt配件名称.VerifyType = null;
