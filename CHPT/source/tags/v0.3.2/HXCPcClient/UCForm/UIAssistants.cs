...
namespace HXCPcClient.UCForm
{
    ...
    public static class UIAssistants
    {
        ...
        static UIAssistants()
        {
            DbColumnsInfo = DBHelper.GetTable("查询数据库列信息", "v_tables_info", "*", "", "", "");
        }
        #endregion
        ...
        public static String GetDicName(String id, out String msg)
        {
            msg = String.Empty;
            try
            {
        ...
        public static void DgvCellDataConvert2DicData(DataGridView sender, DataGridViewCellFormattingEventArgs args, String dpName)
        {
            ...
            string msg;
            args.Value = GetDicName(args.Value.ToString(), out msg);
        }
        /// <summary>
        /// 将数据表格中的数据转换为相对应的日期
        /// </summary>
