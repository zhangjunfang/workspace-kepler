...
namespace HXCPcClient.Chooser
{
    ...
    public partial class frmVehicleGrade : FormEx
    {
        ...
        private void BindPageData(string where)
        {
            ...
            var dt = DBHelper.GetTableByPage("选择器车辆档案列表", "tb_vehicle a left join tb_customer b on a.cust_id=b.cust_id left join tr_driver_vehicle c on a.v_id=c.v_id left join tb_contacts d on c.driver_id=d.cont_id", strFileds, where, "", "order by a.v_id", pageQ.PageIndex, pageQ.PageSize, out recordCount);
