    ...
    public partial class DataGridViewEx : DataGridView
    {
        ...
        protected override void OnCellMouseClick(DataGridViewCellMouseEventArgs e)
        {
            ...
            if (this.Columns[0] is DataGridViewCheckBoxColumn)
            {
                ...
                if ((bool)this.CurrentRow.Cells[0].EditedFormattedValue)
                {
                    this.CurrentRow.Cells[0].Value = false;
                }
                else
                {
                    this.CurrentRow.Cells[0].Value = true;
                }
            }
            base.OnCellMouseClick(e);
        }
        ...
        public DataTable GetBoundData()
        {
            ...
            foreach (DataGridViewColumn dgvc in this.Columns)
            {
                ...
                if (dgvc is DataGridViewTextBoxColumn || dgvc is DataGridViewComboBoxColumn)
                {
                    if (!dt.Columns.Contains(dgvc.Name) && dgvc.HeaderText.Length > 0)
                    {
            ...
            foreach (DataGridViewRow dgvr in this.Rows)
            {
                ...
                foreach (DataGridViewColumn dgvc in this.Columns)
                {
                    ...
                    {
                        dr[dgvc.Name] = dgvr.Cells[dgvc.Name].FormattedValue;
                    }
                }
                dt.Rows.Add(dr);
            }
