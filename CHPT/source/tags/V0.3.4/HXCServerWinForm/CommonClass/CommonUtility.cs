...
namespace HXCServerWinForm.CommonClass
{
    public class CommonUtility
    {
        ...
        public static string BackupDb(string accCode, string bak_filename)
        {
            ...
            #region 备份数据库
            string sqlStr = string.Format("BACKUP DATABASE {0} TO DISK = '{1}' ", GlobalStaticObj_Server.DbPrefix + accCode, GlobalStaticObj_Server.Instance.DbServerBackDir + bak_filename);
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                #endregion
                Utility.Log.Log.writeLineToLog("【账套备份】" + ex.Message, "server");
        ...
        public static string RestoreDb(string accCode, string bak_filename)
        {
            ...
            catch (Exception ex)
            {
                ...
                #endregion
                Utility.Log.Log.writeLineToLog("【账套还原】" + ex.Message, "server");
