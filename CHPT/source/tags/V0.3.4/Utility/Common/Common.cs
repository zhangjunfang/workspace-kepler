...
namespace Utility.Common
{
    public abstract class Common
    {
        ...
        public static string UtcLongToLocalDateTime(object ticks)
        {
            ...
            //if (tTicks > tempTicks)
            //{
            //    tTicks = (tTicks - new DateTime(1970, 1, 1, 0, 0, 0).ToUniversalTime().Ticks) / 10000;
            //}
            //System.DateTime startTime = new System.DateTime(1970, 1, 1);
            //DateTime dt = startTime.AddTicks(Convert.ToInt64(tTicks) * 10000).ToLocalTime();
        ...
        public static void ShowInformation(string information)
        {
            ...
            MessageBox.Show(information, "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        public static void ShowWarning(string warning)
        {
            ...
            MessageBox.Show(warning, "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        ...
        public static void ShowError(string error)
        {
            ...
            MessageBox.Show(error, "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        public static bool ShowQuestion(string question)
        {
            ...
            if (MessageBox.Show(question, "系统提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
                return true;
            else
                return false;
        }
