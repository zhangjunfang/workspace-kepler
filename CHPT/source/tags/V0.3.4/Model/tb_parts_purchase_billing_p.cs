...
namespace Model
{
    ...
    public class tb_parts_purchase_billing_p
    {
        ...
        /// 业务数量
        /// </summary>		
        private int _business_counts;
        public int business_counts
        {
        ...
        /// 退货业务数量
        /// </summary>		
        private int _return_bus_count;
        public int return_bus_count
        {
        ...
        /// 被引用辅助数量
        /// </summary>		
        private int _assisted_count;
        public int assisted_count
        {
