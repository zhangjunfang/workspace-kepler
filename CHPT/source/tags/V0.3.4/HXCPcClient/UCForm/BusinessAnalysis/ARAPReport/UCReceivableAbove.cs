...
namespace HXCPcClient.UCForm.BusinessAnalysis.ARAPReport
{
    public partial class UCReceivableAbove : UCReport
    {
        ...
        void BindData()
        {
            ...
            string filed = "b.cust_code,b.cust_name,a.本期发生,b.credit_line,a.本期发生-ISNULL(b.credit_line,0) 超信用额度";
            string table = string.Format(@"(
select cust_id,SUM(本期发生) 本期发生 from v_receivable_document where 单据日期<{0}
group by cust_id) a
