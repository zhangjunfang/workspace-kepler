...
namespace HXCPcClient.UCForm.RepairBusiness.RepairCallback
{
    ...
    public partial class UCRepairCallbackManager : UCBase
    {
        ...
        private void SubmitAndVerify(string strMessage, DataSources.EnumAuditStatus status)
        {
            ...
            foreach (DataGridViewRow dr in dgvRData.Rows)
            {
                ...
                if (isCheck != null && (bool)isCheck)
                {
                    ...
                    dicParam.Add("repair_no", new ParamObj("repair_no", CommonUtility.GetNewNo(SYSModel.DataSources.EnumProjectType.RepairCallback), SysDbType.VarChar, 40));//单据编号                   
        ...
        {
            UCRepairCallbackManager_AddEvent(null, null);
        }
        /// <summary>
        /// 右键复制
        /// </summary>
        ...
        {
            UCRepairCallbackManager_CopyEvent(null, null);
        }
        /// <summary>
        /// 右键删除
        /// </summary>
        ...
        {
            UCRepairCallbackManager_DeleteEvent(null, null);
        }
        /// <summary>
        /// 右键提交
        /// </summary>
        ...
        {
            UCRepairCallbackManager_SubmitEvent(null, null);
        }
        /// <summary>
        /// 右键审核
        /// </summary>
        ...
        {
            UCRepairCallbackManager_VerifyEvent(null, null);
        }
        /// <summary>
        /// 右键编辑
        /// </summary>
        ...
        {
            UCRepairCallbackManager_EditEvent(null, null);
        }
        #endregion
