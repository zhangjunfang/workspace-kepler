...
namespace HXCPcClient.UCForm.RepairBusiness.RepairQuery
{
    ...
    public partial class RepairQueryManager : UCBase
    {
        ...
        public RepairQueryManager(string whereStr)
        {
            InitializeComponent();
            this.InitUC();
            this.strWhere = whereStr;
        }
        private void InitUC()
        {
        ...
        public void _BindPageData()
        {
            try
            {
                ...
                {
                    strWhere += string.Format(" and  a.maintain_payment like '%{0}%'", cobRepType.SelectedValue.ToString());
                }
        ...
        public void BindProjectPageData()
        {
            try
            {
                ...
                strWhere = string.Format(" a.enable_flag in ('1','2') and a.info_status='2'");//enable_flag 1未删除
        ...
        public void BindYLPageData()
        {
            try
            {
                ...
                strWhere = string.Format(" a.enable_flag='" + Convert.ToInt32(DataSources.EnumEnableFlag.USING).ToString() + "' and a.info_status='2'");//enable_flag 1未删除
        ...
        private void DoubleClickCell(DataGridView dgvView, string strIdName)
        {
            ...
            base.addUserControl(view, "维修调度单-预览", "RepairQueryView" + strRepairId, this.Tag.ToString(), this.Name);
        }
        #endregion
        ...
        private void dgvQData_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (fieldNmae.Equals("dispatch_status"))
            {
                ...
                {
                    if (CommonCtrl.IsNullToString(dgvQData.Rows[e.RowIndex].Cells["info_status"].Value) != Convert.ToInt32(DataSources.EnumAuditStatus.AUDIT).ToString())
                    {
        ...
        private void dgvYlData_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (fieldNmae.Equals("dispatch_status"))
            {
                ...
                {
                    if (CommonCtrl.IsNullToString(dgvYlData.Rows[e.RowIndex].Cells["Yinfo_status"].Value) != Convert.ToInt32(DataSources.EnumAuditStatus.AUDIT).ToString())
                    {
