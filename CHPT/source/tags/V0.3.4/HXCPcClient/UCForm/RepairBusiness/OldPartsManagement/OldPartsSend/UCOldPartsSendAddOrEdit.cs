...
namespace HXCPcClient.UCForm.RepairBusiness.OldPartsManagement.OldPartsSend
{
    ...
    public partial class UCOldPartsSendAddOrEdit : UCBase
    {
        ...
        private void deleteParts_Click(object sender, EventArgs e)
        {
            ...
            string strItemId = CommonCtrl.IsNullToString(dgvMaterials.CurrentRow.Cells["parts_id"].Value);
            if (!string.IsNullOrEmpty(strItemId))
            {
                ...
                DBHelper.BatchUpdateDataByIn("删除配件", "tb_maintain_oldpart_material_detail", comField, "parts_id", listField.ToArray());
