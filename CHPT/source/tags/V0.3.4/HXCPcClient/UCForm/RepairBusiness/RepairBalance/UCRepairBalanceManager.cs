...
namespace HXCPcClient.UCForm.RepairBusiness.RepairBalance
{
    ...
    public partial class UCRepairBalanceManager : UCBase
    {
       ...
       /// <param name="strType">操作类型，0为预览，1为双击单元格</param>
        ...
        public void BindPageData()
        {
            try
            {
                ...
                string strFiles = @"b.maintain_no,a.man_hour_sum,a.fitting_sum,a.other_item_sum,a.privilege_cost,a.should_sum,a.received_sum
                                     ...
                                     ,b.maintain_type,b.remark,a.maintain_id";
                int recordCount;
        ...
        {
            UCRepairBalanceManager_AddEvent(null, null);
        }
        /// <summary>
        /// 右键复制
        /// </summary>
        ...
        {
            UCRepairBalanceManager_CopyEvent(null, null);
        }
        /// <summary>
        /// 右键删除
        /// </summary>
        ...
        {
            UCRepairBalanceManager_DeleteEvent(null, null);
        }
        /// <summary>
        /// 右键结算
        /// </summary>
        ...
        {
            UCRepairBalanceManager_BalanceEvent(null, null);
        }
        /// <summary>
        /// 右键审核
        /// </summary>
        ...
        {
            UCRepairBalanceManager_VerifyEvent(null, null);
        }
        /// <summary>
        /// 右键编辑
        /// </summary>
        ...
        {
            UCRepairBalanceManager_EditEvent(null, null);
        }
        #endregion
    }
}
