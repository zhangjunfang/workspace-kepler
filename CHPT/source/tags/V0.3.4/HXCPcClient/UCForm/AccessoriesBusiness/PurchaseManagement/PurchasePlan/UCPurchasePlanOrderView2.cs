...
{
    public partial class UCPurchasePlanOrderView2 : UCBase
    {
        #region 变量
        string planId = string.Empty;
        UCPurchasePlanOrderManagView uc;
        private tb_parts_purchase_plan tb_purchase_Model = new tb_parts_purchase_plan();
        #endregion

        public UCPurchasePlanOrderView2(string plan_id, UCPurchasePlanOrderManagView uc)
        {
            InitializeComponent();
            this.uc = uc;
            this.planId = plan_id;
        ...
        void UCPurchasePlanOrderView_SaveEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql1 = string.Format(@" Update tb_parts_purchase_plan Set is_suspend=@is_suspend,update_by=@update_by,suspend_reason=@suspend_reason,
