                ...
                if (result == DialogResult.OK)
                {
                    ...
                    if (List_PartInfo.Count > 0)
                    {
                        for (int i = 0; i < List_PartInfo.Count; i++)
                        {
                            ...
                            if (!IsExist)
                            {
                                string wherestr = " plan_id='" + planid + "' and parts_code='" + partscode + "' and is_suspend=1 and finish_counts<business_counts and len(car_factory_code)>0";
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    if (List_PartInfo.Count > 0)
                    {
                        for (int i = 0; i < List_PartInfo.Count; i++)
                        {
                            ...
                            if (!IsExist)
                            {
                                string wherestr = " sale_order_id='" + sale_order_id + "' and parts_code='" + partscode + "' and is_suspend=1 and len(car_factory_code)>0 ";
