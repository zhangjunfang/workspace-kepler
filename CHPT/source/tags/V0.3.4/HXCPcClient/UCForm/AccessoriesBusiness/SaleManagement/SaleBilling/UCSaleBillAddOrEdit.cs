...
namespace HXCPcClient.UCForm.AccessoriesBusiness.SaleManagement.SaleBilling
{
    public partial class UCSaleBillAddOrEdit : UCBase
    {
        ...
        private void UCSaleBillAddOrEdit_Load(object sender, EventArgs e)
        {
            ...
            string[] NotReadOnlyColumnsName = new string[] { "colCheck", "wh_id", "unit_id", "original_price", "business_price", "business_count", "discount", "tax_rate", "is_gift", "make_date", "arrival_date", "return_count", "library_count", "remark" };
