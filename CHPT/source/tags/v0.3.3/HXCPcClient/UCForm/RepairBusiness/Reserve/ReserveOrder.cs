...
namespace HXCPcClient.UCForm.RepairBusiness.Reserve
{
    ...
    public partial class ReserveOrder : UCBase
    {
        ...
        void ReserveOrder_SubmitEvent(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in dgvRData.Rows)
            {
                ...
                if (isCheck != null && (bool)isCheck)
                {
                    ...
                    obj.cmdType = CommandType.Text;
                    Dictionary<string, ParamObj> dicParam = new Dictionary<string, ParamObj>();
                    dicParam.Add("reservation_no", new ParamObj("reservation_no", CommonUtility.GetNewNo(SYSModel.DataSources.EnumProjectType.Reserve), SysDbType.VarChar, 40));//单据编号
                    dicParam.Add("reserv_id", new ParamObj("reserv_id", dr.Cells["reserv_id"].Value, SysDbType.VarChar, 40));//单据ID
       ...
       /// <param name="e"></param>
        ...
        {
            ReserveOrder_AddEvent(null,null);
        }
        /// <summary>
        /// 右键复制
        /// </summary>
        ...
        {
            ReserveOrder_CopyEvent(null,null);
        }
        /// <summary>
        /// 右键删除
        /// </summary>
        ...
        {
            ReserveOrder_DeleteEvent(null,null);
        }
        /// <summary>
        /// 右键提交
        /// </summary>
        ...
        {
            ReserveOrder_SubmitEvent(null,null);
        }
        /// <summary>
        /// 右键审核
        /// </summary>
        ...
        {
            ReserveOrder_VerifyEvent(null,null);
        }
        /// <summary>
        /// 右键编辑
        /// </summary>
        ...
        {
            ReserveOrder_EditEvent(null,null);
        }
        #endregion
    }
}
