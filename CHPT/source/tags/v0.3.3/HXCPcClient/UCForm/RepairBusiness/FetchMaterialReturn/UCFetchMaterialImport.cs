    ...
    public partial class UCFetchMaterialImport : FormChooser
    {
        ...
        private void BindData()
        {
            try
            {
                ...
                #endregion
                string strFiles = "a.material_num,a.fetch_opid,b.parts_name,b.quantity,a.customer_name,a.customer_code,a.vehicle_no,a.vehicle_model,a.fetch_time,a.fetch_id,b.material_id";
                strWhere = string.Format(" a.enable_flag='1' and a.info_status='" + Convert.ToInt32(DataSources.EnumAuditStatus.AUDIT).ToString() + "' and a.Import_status='" + Convert.ToInt32(DataSources.EnumImportStaus.OPEN).ToString() + "'");//enable_flag 1未删除
