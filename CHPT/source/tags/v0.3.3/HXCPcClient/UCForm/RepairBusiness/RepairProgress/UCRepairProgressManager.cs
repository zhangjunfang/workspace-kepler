...
namespace HXCPcClient.UCForm.RepairBusiness.RepairProgress
{
    ...
    public partial class UCRepairProgressManager : UCBase
    {
        ...
        private void txtRepairWorker_ChooserClick(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {      
                txtRepairWorker.Text = frmSelector.strPersonName.Substring(0,frmSelector.strPersonName.Length-1);
       ...
       /// <param name="strKey">维修工Id</param>
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            string strFiles="a.maintain_id,a.dispatch_status,a.vehicle_no,b.dispatch_id";
            string strWhere=" a.dispatch_status in ('0','1','2','3','4') and b.dispatch_id in (" + strSelectId.Substring(0, strSelectId.Length - 1) + ") ";
            ...
            for (int i = 0; i < ArryWorkers.Length; i++)
            {
                for (int j = 0; j < dt.Rows.Count; j++)
                {
                    ...
                    if (ArryWorkersTag[i] == CommonCtrl.IsNullToString(dr["dispatch_id"]))
                    {
