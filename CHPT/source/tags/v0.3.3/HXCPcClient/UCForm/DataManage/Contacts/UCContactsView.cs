...
namespace HXCPcClient.UCForm.DataManage.Contacts
{
    public partial class UCContactsView : UCBase
    {
        ...
        private void UCContactsView_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = DBHelper.GetTable("联系人预览", "v_contacts", string.Format("*,{0} phone", EncryptByDB.GetDesFieldValue("cont_phone")), string.Format(" cont_id='{0}'", contID), "", "");
            ...
            else
            {
                ...
                lblContTel.Text = CommonCtrl.IsNullToString(dr["cont_tel"]);
