...
namespace HXCPcClient.UCForm.BusinessAnalysis
{
    ...
    public partial class UCReport : UCBase
    {
        ...
        public UCReport(string styleObject, string styleTitle)
        {
            ...
            this.MoreEvent += new ClickHandler(UCReport_MoreEvent);
        ...
        //报表设置
        void UCReport_MoreEvent(object sender, EventArgs e)
        {
            //报表设置
        ...
        protected void SetReportSet()
        {
            ...
            {
                if (ctr is DataGridViewEx)
                {
                    DataGridViewEx dgv = (DataGridViewEx)ctr;
                    //查询用户对报表的设置
