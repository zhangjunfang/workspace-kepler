...
namespace HXCPcClient.UCForm.BusinessAnalysis.ARAPReport
{
    public partial class UCReceivableAged : UCReport
    {
        ...
        void BindData()
        {
            ...
            strWhere += " and a.allmoney>isnull(c.money,0)";//只查未完全结算的
            string files = @"a.order_type,a.order_num,a.order_date,a.allmoney,isnull(c.money,0),a.allmoney-isnull(c.money,0) waitmoney,a.cust_code,a.cust_name,a.sale_billing_id ";
