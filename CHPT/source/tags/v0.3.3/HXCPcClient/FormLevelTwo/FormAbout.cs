...
{
    public partial class FormAbout : FormEx
    {
        public FormAbout()
        {
            InitializeComponent();
        ...
        {
            this.label1.Text = "名称：" + AssemblyProduct;
            this.label2.Text = "版本：" + AssemblyVersion;
            this.label3.Text = "版权：" + AssemblyCopyright;
            this.label4.Text = "公司：" + AssemblyCompany;
