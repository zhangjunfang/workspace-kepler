...
namespace HXCPcClient.LoginForms
{
    public partial class FormLogin : Form
    {
        ...
        private void LoginResult(object obj)
        {
            ...
            {
                FormMessgeBox.ShowMsg(this, "返回Dataset为null", this.panelTop.BackColor);
                FormLoading.EndLoading();
                this.enableFlag = true;
                return;
            }
            ...
            try
            {
                ...
                GlobalStaticObj.CookieStr = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables["cookieStr"].Rows[0][0].ToString();
                GlobalStaticObj.UserID = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["user_id"].ToString();
                GlobalStaticObj.UserName = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["user_name"].ToString();
                GlobalStaticObj.LandName = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["land_name"].ToString();
                GlobalStaticObj.PassWord = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["password"].ToString();
                GlobalStaticObj.CurrUserCom_Id = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["com_id"].ToString();
                GlobalStaticObj.CurrUserCom_Code = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["com_code"].ToString();
                GlobalStaticObj.CurrUserCom_Name = HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["com_name"].ToString();
