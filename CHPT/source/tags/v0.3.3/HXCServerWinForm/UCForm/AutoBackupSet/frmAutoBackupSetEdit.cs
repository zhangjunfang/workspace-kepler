...
namespace HXCServerWinForm.UCForm.AutoBackupSet
{
    public partial class frmAutoBackupSetEdit : FormEx
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (DBHelper.IsExist("判断帐套备份信息是否存在", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "sys_auto_backup_set", "set_book_id='" + cmbWeek.SelectedValue.ToString() + "'"))
            {
            ...
            dicFields.Add("set_book_id", cmbAcc.SelectedValue.ToString());
        ...
        public void BindCmx()
        {
            DataTable dt = DBHelper.GetTable("获取帐套信息", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "sys_setbook", "id,setbook_name", "enable_flag='1'", "", "");
        ...
        private void BindData()
        {
            ...
            if (dtTask.Rows.Count > 0)
            {
                ...
                cmbAcc.SelectedValue = dr["set_book_id"].ToString();
