...
namespace HXCServerWinForm.UCForm.AcountSet
{
    public partial class frmAccountEdit : FormEx
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Utility.Log.Log.writeLineToLog(ex.Message, "帐套设置-保存失败");
        ...
        private void btnCreateAcc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSql.Append("sale_param_id,sales_plan_audit,sales_order_audit,sales_open_audit,sales_open_outin,sales_order_line_credit,sales_open_line_credit,single_editors_same_person,single_audit_same_person,single_disabled_same_person,single_delete_same_person,create_by,create_time,set_book_id");
                strSql.Append(") values (");
                strSql.Append("@sale_param_id,@sales_plan_audit,@sales_order_audit,@sales_open_audit,@sales_open_outin,@sales_order_line_credit,@sales_open_line_credit,@single_editors_same_person,@single_audit_same_person,@single_disabled_same_person,@single_delete_same_person,@create_by,@create_time,@set_book_id) ");
                ...
                strSql.Append("stock_param_id,storage_manage,making_audit_one_person,allow_zero_lib_stock,allow_zero_lib_junction,single_editors_one_person,single_audit_one_person,single_disabled_one_person,single_delete_one_person,monthly_average_method,moving_average_method,fifo_method,counts,counts_zero,price,price_zero,warehous_single_reference,create_by,create_time,set_book_id,batch_manage");
                strSql.Append(") values (");
                strSql.Append("@stock_param_id,@storage_manage,@making_audit_one_person,@allow_zero_lib_stock,@allow_zero_lib_junction,@single_editors_one_person,@single_audit_one_person,@single_disabled_one_person,@single_delete_one_person,@monthly_average_method,@moving_average_method,@fifo_method,@counts,@counts_zero,@price,@price_zero,@warehous_single_reference,@create_by,@create_time,@set_book_id,@batch_manage) ");
                ...
                strSql.Append("financial_ser_param_id,tax_rate,currency,counts,counts_zero,price,price_zero,create_by,create_time,set_book_id");
                strSql.Append(") values (");
                strSql.Append("@financial_ser_param_id,@tax_rate,@currency,@counts,@counts_zero,@price,@price_zero,@create_by,@create_time,@set_book_id) ");
            ...
            {
                Utility.Log.Log.writeLineToLog(ex.Message, "帐套设置-新增失败");
        ...
        public bool SaveRepairParam()
        {
            ...
            bool flag = DBHelper.Submit_AddOrEdit("保存维修参数", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "sys_repair_param", "set_book_id", id, dicFields);
            return flag;
        }
        ...
        public bool SavePurchaseParam()
        {
            ...
            bool flag = DBHelper.Submit_AddOrEdit("保存采购参数", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "sys_purchase_param", "set_book_id", id, dicFields);
            return flag;
        }
        ...
        public bool SaveSaleParam()
        {
            ...
            bool flag = DBHelper.Submit_AddOrEdit("保存销售参数", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "sys_sale_param", "set_book_id", id, dicFields);
            return flag;
        }
        ...
        public bool SaveStockParam()
        {
            ...
            bool flag = DBHelper.Submit_AddOrEdit("保存库存参数", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "sys_stock_param", "set_book_id", id, dicFields);
            return flag;
        }
        ...
        public bool SavefinancParam()
        {
            ...
            bool flag = DBHelper.Submit_AddOrEdit("保存财务参数", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "sys_financial_ser_param", "set_book_id", id, dicFields);
            return flag;
        }
