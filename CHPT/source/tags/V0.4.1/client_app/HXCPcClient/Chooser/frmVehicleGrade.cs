...
namespace HXCPcClient.Chooser
{
    ...
    public partial class frmVehicleGrade : FormEx
    {
        ...
        private void BindPageData(string where)
        {
            ...
            string strFileds = string.Format("top(200) *,{0} phone", EncryptByDB.GetDesFieldValue("cont_phone"));
            var dt = DBHelper.GetTableByPage("选择器车辆档案列表", "v_vehicle", strFileds, where, "", "order by create_time desc", pageQ.PageIndex, pageQ.PageSize, out recordCount);
