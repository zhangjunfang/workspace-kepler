...
{
    public partial class QueryProgressFrm : Form
    {
        public int MaxNum = 0;
        public static int CurrentValue = 0;
        private Thread ProgressThread = null;//声明一个执行委托的线程
        public QueryProgressFrm()
        {
            InitializeComponent();
        }
        private delegate void DoDataDelegate(object MaxValue);//传值委托
        private void QueryProgressFrm_Load(object sender, EventArgs e)
        {
            MaxNum = 100;
