...
namespace HXCPcClient.UCForm.DataManage.WareHouse
{
    public partial class UCWareHouseManager : UCBase
    {
        ...
        private void gvWareHouseList_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            //if (dgvWareHouseList.CurrentCell == null)
            //{
            //    return;
            //}

            ////单击选择框
            //if (dgvWareHouseList.CurrentCell.OwningColumn.Name == colCheck.Name)
            //{
            //    SetSelectedStatus();
            //}
        }
