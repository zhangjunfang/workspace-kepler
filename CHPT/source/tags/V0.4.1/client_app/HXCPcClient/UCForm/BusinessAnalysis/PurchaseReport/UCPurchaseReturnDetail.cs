...
namespace HXCPcClient.UCForm.BusinessAnalysis.PurchaseReport
{
    public partial class UCPurchaseReturnDetail : UCReport
    {
            ...
            : base("v_purchase_return_detail_report", "采购退换货汇总表")
        {
            ...
            colBackNum.DefaultCellStyle = styleNum;
            colBackPrice.DefaultCellStyle = styleMoney;
            colBackPayment.DefaultCellStyle = styleMoney;
            colBackTax.DefaultCellStyle = styleMoney;
            colBackMoney.DefaultCellStyle = styleMoney;
            colReplaceNum.DefaultCellStyle = styleNum;
            colReplacePrice.DefaultCellStyle = styleMoney;
            colReplacePayment.DefaultCellStyle = styleMoney;
            colReplaceTax.DefaultCellStyle = styleMoney;
            colReplaceMoney.DefaultCellStyle = styleMoney;
        }
        //窗体加载
