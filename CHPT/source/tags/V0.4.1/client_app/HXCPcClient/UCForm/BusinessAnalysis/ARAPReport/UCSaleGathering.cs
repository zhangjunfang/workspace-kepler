...
namespace HXCPcClient.UCForm.BusinessAnalysis.ARAPReport
{
    public partial class UCSaleGathering : UCReport
    {
        ...
        void BindData()
        {
            ...
            string files = @"a.order_type,a.order_num,a.order_date,a.allmoney,isnull(a.balance_money,0) balance_money,a.allmoney-isnull(a.balance_money,0) waitmoney,a.receipt_type_name,a.receivables_date,
