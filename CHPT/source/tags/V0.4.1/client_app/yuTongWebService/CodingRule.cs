...
namespace yuTongWebService
{
    ...
    public class CodingRule
    {
        ...
        public string GetPrefix(string billCode, string codeMethod, string delimiter)
        {
        ...
        private string GetStrByCodeMethod(SYSModel.DataSources.EnumBillCodeMethod enumBillCodeMethod)
        {
