    ...
    public partial class TrackBarEx : Control
    {
                                     ...
                                     Color barPenColorPaint, Color elapsedOuterColorPaint, Color elapsedInnerColorPaint)
        {
            try
            {
                ...
                System.Drawing.Drawing2D.LinearGradientMode gradientOrientation;
                if (barOrientation == Orientation.Horizontal)
                {
                    barRect.Inflate(-1, -barRect.Height / 3);
                    barHalfRect = barRect;
                    barHalfRect.Height /= 2;
                    gradientOrientation = System.Drawing.Drawing2D.LinearGradientMode.Vertical;
                ...
                else
                {
                    ...
                    barHalfRect = barRect;
                    barHalfRect.Width /= 2;
                    gradientOrientation = System.Drawing.Drawing2D.LinearGradientMode.Horizontal;
                ...
                //draw bar
                using (
                 System.Drawing.Drawing2D.LinearGradientBrush lgbBar =
