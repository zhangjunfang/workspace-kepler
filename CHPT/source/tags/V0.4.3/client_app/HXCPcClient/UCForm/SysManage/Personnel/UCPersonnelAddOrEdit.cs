...
namespace HXCPcClient.UCForm.SysManage.Personnel
{
    ...
    public partial class UCPersonnelAddOrEdit : UCBase
    {
        ...
        private void UCPersonnelAddOrEdit_Load(object sender, EventArgs e)
        {
            ...
            this.InitData();
            if (wStatus == WindowStatus.Add && org_name != string.Empty && org_id != string.Empty && com_name != string.Empty)
            {
        ...
        private bool Validator(ref string msg)
        {
            ...
            {
                if (!string.IsNullOrEmpty(txtidcard_num.Caption.Trim()) && !Utility.Common.Validator.IsIDCard(txtidcard_num.Caption.Trim()))
                {
