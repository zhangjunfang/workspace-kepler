...
namespace HXC.UI.Library.Controls
{
    ...
    ///     </version>
    /// </versioning>
    public partial class ExtUserControl : Panel, IBorderStyle, INotifyPropertyChanged, IContentControl
    {
        ...
        private void ExtUserControl_SizeChanged(object sender, EventArgs e)
        {
            Invalidate(true);
        }
