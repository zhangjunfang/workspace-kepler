package com.ctfo.travel.basic.controller;
...
public class AutoCodeInit {
	...
	public void init() throws TimeoutException {
		GeneratingCode initCode = new GeneratingCode(sysCompanyDao.queryMaxCode(),tbOrgDAO.queryMaxCode(),sysSpOperatorDAO.queryMaxCode(),sysSpRoleDAO.queryMaxCode());
	}
