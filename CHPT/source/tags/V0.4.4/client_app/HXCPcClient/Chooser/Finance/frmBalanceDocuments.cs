...
namespace HXCPcClient.Chooser
{
    public partial class frmBalanceDocuments : FormChooser
    {
        ...
        public frmBalanceDocuments( string custCode)
        {
            ...
            dgvData.ReadOnly = false;
            DataGridViewEx.SetDataGridViewStyle(dgvData);
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            dtiDate.StartDate = string.Empty;
            dtiDate.EndDate = string.Empty;
            dtiBillDate.StartDate = string.Empty;
            dtiBillDate.EndDate = string.Empty;
        }
        //取消
