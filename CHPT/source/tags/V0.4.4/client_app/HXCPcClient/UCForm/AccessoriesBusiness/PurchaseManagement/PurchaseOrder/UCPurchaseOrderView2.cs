...
{
    public partial class UCPurchaseOrderView2 : UCBase
    {
        #region 变量
        string orderId = string.Empty;
        UCPurchaseOrderManagerView uc;
        ...
        void UCPurchaseOrderView_SaveEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql1 = string.Format(@" Update tb_parts_purchase_order Set is_suspend=@is_suspend,update_by=@update_by,
