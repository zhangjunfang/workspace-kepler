...
namespace HXCPcClient.UCForm.RepairBusiness.YuTongThreeGuaranty.MaintainThreeGuaranty
{
    ...
    public partial class UCMaintainThreeGuarantyQuery : UCBase
    {
        ...
        #region Property -- 属性
        private LoggingService _loggingService = GlobalStaticObj.GlobalLogService;
        #endregion
        ...
        private void FuncationRegiste()  //注册控件相关事件
        {
            ...
            btn_query.Click += delegate
            {
                try
                {
                    ...
                    {
                        _where += string.Format(" and approve_state like '%{0}%'", CommonCtrl.IsNullToString(cbo_approve_status_yt.SelectedValue));
                    }
