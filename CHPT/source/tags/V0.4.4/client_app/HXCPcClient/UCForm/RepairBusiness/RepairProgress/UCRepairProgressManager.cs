...
namespace HXCPcClient.UCForm.RepairBusiness.RepairProgress
{
    ...
    public partial class UCRepairProgressManager : UCBase
    {
        ...
        private Dictionary<String, String> dci = null;
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            dic.Add((cobStation.SelectedValue).ToString(), cobStation.Text);
            RepairProgress.ExtDataGrid.BuildGridColumns(cobStation.Text == "全部" ? dci : dic, dicTwoColumns);//生成表头
