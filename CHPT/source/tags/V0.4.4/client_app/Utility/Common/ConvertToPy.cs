...
namespace Utility.Common
{
    /// <summary>汉字转拼音
    /// create by syn
    /// create in 2014-10-20
    /// </summary>
    public class ConvertToPy
    {
        #region 属性数据定义
        /// <summary>
        /// 汉字的机内码数组
        ...
        /// <summary>
        /// 汉字转拼音缩写(不建议使用，部分汉子无法转换)
        /// </summary>
        /// <param name="str">要转换的汉字字符串</param>
        /// <returns>拼音缩写</returns>
        private static string GetSpellStringLower(string str)
        {
            string tempStr = "";
        ...
        /// </summary>
        /// <param name="str">要转换的汉字字符串</param>
        /// <param name="IsContainCharac">是否转换字符</param>
        /// <returns>拼音缩写</returns>
        public static string GetSpellStringLower(string str, bool IsContainCharac)
        {
            if (string.IsNullOrEmpty(str)) return string.Empty;
            str = str.Replace("参", "深");
            if (IsContainCharac) return GetPYString(str).ToLower();
            else return GetPYChar(str).ToLower();
        }
        ...
        /// <param name="IsContainCharac">是否转换字符</param>
        /// <returns>拼音缩写</returns>
        public static string GetSpellStringSupper(string str, bool IsContainCharac)
        {
            if (IsContainCharac) return GetPYString(str).ToUpper();
            else return GetPYChar(str).ToUpper();
        }
        #endregion
        ...
        private static string GetPYChar(string strText)
        {
