...
{
    public delegate void MainFormAddLabels(DataRow fun, string menuName);//定义委托 
    public partial class UCLeftMenu : UserControl
    {
        ...
        void lbl_Click(object sender, EventArgs e)
        {
            ...
            MainFormAddLabel(fun, this.Name);

            Action<string, string> OpLog = CommonClass.DBHelper.LogFunctionCall;
            OpLog.BeginInvoke((sender as Label).Tag.ToString(), GlobalStaticObj.CurrAccID, null, null);
        }
        /// <summary>
        /// 二级菜单事件
        /// </summary>
        ...
        void Pleft_panel_tiem_top_Click(object sender, EventArgs e)
        {
            ...
            Action<string, string> OpLog = CommonClass.DBHelper.LogFunctionCall;
            OpLog.BeginInvoke((sender as PanelEx).Tag.ToString(), GlobalStaticObj.CurrAccID, null, null);
        }
        /// <summary>
        /// tree 三级菜单事件
        /// </summary>
        ...
        {           
            ...
            Action<string, string> OpLog = CommonClass.DBHelper.LogFunctionCall;
            OpLog.BeginInvoke(e.Node.Tag.ToString(), GlobalStaticObj.CurrAccID, null, null);
        }
        /// <summary>
        /// 展开/折叠
        /// </summary>
