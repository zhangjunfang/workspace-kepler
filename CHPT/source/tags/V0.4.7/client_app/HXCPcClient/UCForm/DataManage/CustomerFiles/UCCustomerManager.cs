...
namespace HXCPcClient.UCForm.DataManage.CustomerFiles
{
    ...
    public partial class UCCustomerManager : UCBase
    {
        ...
        #region Property -- 属性
        internal LoggingService LogService4Customer = GlobalStaticObj.GlobalLogService;
        #endregion
        ...
        private void SetFuncationButtonVisible()    //设置功能按钮可见性
        {
            try
            {
                ...
                {
                    btnAdd, btnCopy, btnEdit, btnDelete, btnStatus, btnSubmit, btnSave, btnView, btnCancel, btnExport, btnImport, btnPrint
                };
        ...
        public void BindPageData()
        {
            try
            {
                ...
                int recordCount;
                var dt = DBHelper.GetTableByPage("分页查询客户档案", "tb_customer c left join sys_user u on c.create_by=u.user_id", "c.*,u.user_name", where, "", "c.cust_code desc", pageQ.PageIndex, pageQ.PageSize, out recordCount);
