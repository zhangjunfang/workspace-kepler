    ...
    public partial class UCStockManager : UCBase
    {
        ...
        private bool ValidatorDgv(ref string msg)
        {
            ...
            foreach (int index in this.rowList)
            {
                ...
                if (!isnumeric(MaxEditAfterString) || !isnumeric(MinEditAfterString))
                {
        ...
        private void dgvRecord_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
        }
    }
}
