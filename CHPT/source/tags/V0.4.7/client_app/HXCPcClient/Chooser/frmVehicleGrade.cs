...
namespace HXCPcClient.Chooser
{
    ...
    public partial class frmVehicleGrade : FormEx
    {
        ...
        /// 联系人
        /// </summary>
        public string strContactName = string.Empty;
        /// <summary>
        /// 联系人电话
        /// </summary>
        public string strContactPhone = string.Empty;
        #endregion
        public frmVehicleGrade()
        {
            ...
            {
                string where = " enable_flag='" + Convert.ToInt32(DataSources.EnumEnableFlag.USING).ToString() + "' and status='" + Convert.ToInt32(DataSources.EnumStatus.Start) + "'";
                ...
                {
                    where += string.Format(" and  cust_code like '%{0}%'", txtCCode.Caption.Trim());
                }
                if (!string.IsNullOrEmpty(txtCName.Caption.Trim()))
                {
                    where += string.Format(" and cust_namelike '%{0}%'", txtCName.Caption.Trim());
                }
                BindPageData(String.IsNullOrEmpty(where) ? "enable_flag = '1'" : where);
            };
        }
        ...
        private void SetDgvAnchor()
        {
            ...
            dgvVehicle.Columns["cont_name"].ReadOnly = true;
            dgvVehicle.Columns["phone"].ReadOnly = true;
        }
        #endregion
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            ...
            txtCCode.Caption = string.Empty;
            txtCName.Caption = string.Empty;
            txtEngineNum.Focus();
        }
        #endregion 
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtCName.Caption.Trim()))
            {
                where += string.Format(" and cust_name like '%{0}%'", txtCName.Caption.Trim());
            }
            if (!string.IsNullOrEmpty(txtYardCode.Caption.Trim()))
            {
                where += string.Format(" and turner like '%{0}%'", txtYardCode.Caption.Trim());
            }            
            BindPageData(where);
        }
        #endregion
        ...
        private void dgvUsers_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                strContactName = CommonCtrl.IsNullToString(dgvVehicle.Rows[e.RowIndex].Cells["cont_name"].Value);
                strContactPhone = CommonCtrl.IsNullToString(dgvVehicle.Rows[e.RowIndex].Cells["phone"].Value);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            strContactName = CommonCtrl.IsNullToString(dgvVehicle.CurrentRow.Cells["cont_name"].Value);
            strContactPhone = CommonCtrl.IsNullToString(dgvVehicle.CurrentRow.Cells["phone"].Value);
            this.DialogResult = DialogResult.OK;
            this.Close();
        }
        #endregion
        ...
        #region 回车事件
        private void dgvVehicle_KeyPress(object sender, KeyPressEventArgs e)
        {
