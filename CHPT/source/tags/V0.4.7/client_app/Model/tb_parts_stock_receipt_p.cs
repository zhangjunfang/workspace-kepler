...
namespace Model
{
   public  class tb_parts_stock_receipt_p
    {

        /// <summary>
        /// id
        /// </summary>		
        private string _stock_receipt_parts_id;
        public string stock_receipt_parts_id
        {
            get { return _stock_receipt_parts_id; }
            set { _stock_receipt_parts_id = value; }
        }
        /// <summary>
        /// 其他收货单ID
        /// </summary>		
