...
namespace HXC_FuncUtility
{
    ...
    public class ConfigConst
    {
        ...
        /// Wcf文件传输配置
        /// </summary>
        public static string WcfFile = "HuiXiuCheWcfFileService.HXCWCFFileService";
        ...
        /// 在线用户上传时间
        /// </summary>
        public static string UserUploadTime = "UserUploadTime";
        /// <summary>
        /// 云平台数据通讯配置
        /// </summary>
        public static string CloundData = "CloundData";
        /// <summary>
        /// 云平台文件通讯配置
        /// </summary>
        public static string CloundFile = "CloundFile";
    }
}
