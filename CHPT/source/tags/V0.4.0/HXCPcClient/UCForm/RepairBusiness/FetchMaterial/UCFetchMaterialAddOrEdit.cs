                ...
                foreach (DataGridViewRow dgvr in dgvMaterials.Rows)
                {
                    ...
                    if (strPname.Length > 0 && strPCmoney.Length > 0)
                    {
                        ...
                        if (strPID.Length == 0)
                        {
                         ...
                         ,picking_num,received_num,warehouse,three_warranty,whether_imported,remarks,drawn_no,vehicle_brand,enable_flag,material_id)
        ...
        private void dgvMaterials_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(CommonCtrl.IsNullToString(dgvMaterials.Rows[e.RowIndex].Cells["parts_code"].Value)))
                {
                    ...
                    dgvMaterials.Rows[e.RowIndex].Cells["picking_num"].Value = ControlsConfig.SetNewValue(dgvMaterials.Rows[e.RowIndex].Cells["picking_num"].Value, 1);
                    dgvMaterials.Rows[e.RowIndex].Cells["received_num"].Value = ControlsConfig.SetNewValue(dgvMaterials.Rows[e.RowIndex].Cells["received_num"].Value, 1);
                    dgvMaterials.Rows[e.RowIndex].Cells["notFetchNum"].Value = ControlsConfig.SetNewValue(dgvMaterials.Rows[e.RowIndex].Cells["notFetchNum"].Value, 1);
                    ...
                    dgvMaterials.Rows[e.RowIndex].Cells["inventory_num"].Value = ControlsConfig.SetNewValue(dgvMaterials.Rows[e.RowIndex].Cells["inventory_num"].Value, 1);
                }
            }
            catch (Exception ex)
            {
