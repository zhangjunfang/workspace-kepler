    ...
    public partial class UCYTAddOrEdit : UCBase
    {
        ...
        void GetGridViewRowByDrImport(DataGridViewRow dgvr, DataRow dr, string relation_order, int rowIndex, string ImportType)
        {
            try
            {
                ...
                { 
                    dgvr.Cells["application_count"].Value = int.Parse(dr["business_count"].ToString()) - int.Parse(dr["finish_count"].ToString());//剩余的 业务数量
                }
        ...
        void GetBuesinessCountPartsInfo(ref int application_count, ref int conf_count, ref string parts_codes, ref string parts_names)
        {
            ...
            foreach (DataGridViewRow dr in gvPurchaseList.Rows)
            {
                ...
                parts_names = parts_codes + dr.Cells["parts_name"].Value + ",";
            }
