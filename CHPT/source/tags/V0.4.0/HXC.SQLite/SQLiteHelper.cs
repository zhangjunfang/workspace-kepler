...
namespace HXC.SQLite
{
    public static class SQLiteHelper
    {
        public static string dbName = string.Empty;
        public static Mutex mut;//进程间互斥同步方案
        ...
        //WinForm下
        //public static string connectionString = "Data Source=" + Application.StartupPath + "\\MyInfolibraryDB.db";  //获取绝对路径，看好了，别搞错了
        public static string connectionString = "Data Source=" + Application.StartupPath + "\\"+dbName; 
        static SQLiteHelper()
        {
            mut = new Mutex();
//静态类中的所有成员必须是静态的。
...
//静态成员在第一次被访问之前并且在任何静态构造函数（如调用的话）之前初始化。若要访问静态类成员，应使用类名而不是变量名来指定该成员的位置
        ...
        {
            return "Data Source=" + Application.StartupPath + "\\MyInfolibraryDB.db";  //获取绝对路径，看好了，别搞错了
        }
