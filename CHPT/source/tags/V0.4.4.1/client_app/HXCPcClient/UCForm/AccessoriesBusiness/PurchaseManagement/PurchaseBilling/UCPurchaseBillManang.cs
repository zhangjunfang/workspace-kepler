                    ...
                    for (int i = 0; i < listField.Count; i++)
                    {
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            if (IOPartTable != null && IOPartTable.Rows.Count > 0)
                            {
                                ...
                                dr["PartCount"] = Convert.ToDecimal(IOPartTable.Rows[i]["business_counts"].ToString());//配件业务数量
            ...
            if (dt_surplus != null && dt_surplus.Rows.Count > 0)
            {
                ...
                if (dtPurchaseList.Rows.Count > 0)
                {
                    foreach (DataRow drr in dtPurchaseList.Rows)
                    {
                        ...
                        decimal business_counts = decimal.Parse(drr["business_counts"] == null ? "" : drr["business_counts"].ToString());
