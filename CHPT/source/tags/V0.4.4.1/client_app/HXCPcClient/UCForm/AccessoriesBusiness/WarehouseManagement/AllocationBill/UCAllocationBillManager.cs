    ...
    public partial class UCAllocationBillManager :UCBase
    {
        ...
        public void GetInOutBillList(string WhereStr)
        {
            try
            {
                ...
                sbField.AppendFormat("IOBillTb.{0},{1},{2},{3},{4},{5},{6},{7},TotalCount,{8},{9},{10},IOBillTb.{11}",
                InOutID, OrderTypeName, BillingTypeName, OrderNum, OrderDate,BussinessUnits,
                ...
                "", "IOBillTb.order_date desc", winFormAllocBillPage.PageIndex, winFormAllocBillPage.PageSize, out RecCount);//获取出入库单表查询记录
