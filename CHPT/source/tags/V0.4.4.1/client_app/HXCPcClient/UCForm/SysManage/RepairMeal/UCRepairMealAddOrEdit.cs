        ...
        private void dgvMaterials_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                if (dpt.Rows.Count > 0)
                {
                    ...
                    dgvMaterials.Rows[e.RowIndex].Cells["unit"].Value = CommonCtrl.IsNullToString(dpr["default_unit"]);
        ...
        private void addParts_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                if (dpt.Rows.Count > 0)
                {
                    ...
                    dgvMaterials.CurrentRow.Cells["unit"].Value = CommonCtrl.IsNullToString(dpr["default_unit"]);
