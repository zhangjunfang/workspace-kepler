...
namespace LogService
{
    ...
    ///         <author>Kord Kuo</author> 
    ///         <datetime>2015/01/19 17:09:00</datetime>
    ///         <comment>
    ///             添加参数带日志消息头的日志写入方法
    ///         </comment>
    ///     </version>
    ...
    public class LoggingService
    {
        ...
        /// <param name="logMessage">日志消息信息</param>
        /// <remarks>Version:1.2.2.0</remarks>
        public virtual void WriteLog(String msgHeader, String logMessage)
        {
        ...
        /// <param name="logMessage">异常消息信息</param>
        /// <remarks>Version:1.2.2.0</remarks>
        public virtual void WriteLog(Int32 logGrade, String logHeader, String logMessage)
        {
        }
