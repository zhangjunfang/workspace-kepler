...
(function ($)
{
    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        hasChildren: function (treenodedata)
        {
            ...
            return treenodedata[p.childrenName] ? true : false;
        },
        //获取父节点 数据
        ...
        _appendData: function (treeNode, data)
        {
            ...
            if (treenodedata && treenodedata[p.childrenName] == undefined) treenodedata[p.childrenName] = [];
        ...
        _isExpand : function(o,level)
        {
            ...
            if (typeof (isExpand) == "undefined") return true;
            return true;
        },
        ...
        _getTreeHTMLByData: function (data, outlineLevel, isLast, isExpand)
        {
            ...
            for (var i = 0; i < data.length; i++)
            {
                ...
                if (g.hasChildren(o))
                {
                    ...
                    { 
                        if (delay == true)
                        {
                            g.toggleNodeCallbacks.push({
                                ...
                                {
                                    var content = g._getTreeHTMLByData(o[p.childrenName], outlineLevel + 1, isLastNew, isExpandCurrent).join('');
                                    $(dom).append(content);
                    ...
                    {
                        treehtmlarr.push(g._getTreeHTMLByData(o[p.childrenName], outlineLevel + 1, isLastNew, isExpandCurrent).join(''));
                    }
