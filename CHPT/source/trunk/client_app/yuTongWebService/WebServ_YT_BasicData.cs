    ...
    public class WebServ_YT_BasicData
    {
        ...
        public static string LoadHitchMode()
        {
            ...
            catch (InvalidOperationException ioe)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("故障模式接口", ioe);
                message = ioe.Message;
                return "故障模式接口调用超时！";
            }
            catch (Exception e)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("故障模式接口", e);
                return "故障模式接口调用出错！";
            }
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("故障模式接口", errMsg);
                return "故障模式接口调用失败！";
            }
            ...
            if (!flag)
            {
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("故障模式接口", "故障模式更新失败");
                return "故障模式更新失败";
            }
        ...
        public static string LoadContact(string updateTime, string contType)
        {
            ...
            catch (InvalidOperationException ioe)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("联系人信息同步", ioe);
                return "联系人接口调用超时！";
            }
            catch (Exception e)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("联系人信息同步", e);
                return "联系人接口调用出错";
            }
            string state = Secret.Decrypt3DES_UTF8(result.state, GlobalStaticObj_YT.KeySecurity_YT);
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("联系人信息同步", errMsg);
                return "联系人调用接口失败！";
            }
            ...
            if (!flag)
            {
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("联系人信息同步", "联系人更新失败");
                return "联系人更新失败";
            }
            DateTime dtEnd = GlobalStaticObj_Server.Instance.CurrentDateTime;//结束时间
        ...
        public static string LoadServiceStation(string clientID, string sapCode, bool isSave)
        {
            ...
            catch (InvalidOperationException ioe)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("服务站信息同步", ioe);
                return "服务站接口调用超时！";
            }
            catch (Exception ex)
            {
                //Utility.Log.Log.writeLineToLog(ex, "服务站信息同步");
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("服务站信息同步", ex);
                return "服务站接口调用出错！";
            }
            string state = Secret.Decrypt3DES_UTF8(result.state, GlobalStaticObj_YT.KeySecurity_YT);
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("服务站信息同步", errMsg);
                return "服务站接口调用失败！";
            }
            ...
            else
            {
                ...
                strSql.Append("com_id,parent_id,com_code,com_name,com_short_name,province,city,county,category,zip_code,com_email,com_phone,com_fax,repair_qualification,unit_properties,legal_person,indepen_check,indepen_legalperson,financial_indepen,tax_qualification,tax_num,work_time,staff_counts,ser_staff_counts,trench_counts,reception_area,cust_lounge_area,meeting_room_area,training_room_area,repair_workshop_area,big_repaired_area,parts_sales_area,parts_warehouse_area,ytparts_warehouse_area,oldparts_warehouse_area,repair_instructions,enable_flag,apply_time,approved_time,com_level,workhours_price,winter_subsidy,territory,street,institution_code,service_phone,star_level,sap_code,center_library,data_source,create_by,create_time,update_by,update_time,status");
            ...
            sysSQLString.Param.Add("status", ((int)DataSources.EnumStatus.Start).ToString());//状态
            string dtApplyTime = "";
            ...
            if (!flag)
            {
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("服务站信息同步", "更新服务站信息失败");
                return "更新服务站信息失败！";
            }
        ...
        public static string LoadBus(string updateTime)
        {
            ...
            catch (InvalidOperationException ioe)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆信息同步", ioe);
                message = ioe.Message;
                return "车辆信息同步超时！";
            }
            catch (TimeoutException te)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆信息同步", te);
                message = te.Message;
                return "车辆信息同步出错！";
            }
            string state = Secret.Decrypt3DES_UTF8(result.state, GlobalStaticObj_YT.KeySecurity_YT);
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆信息同步", errMsg);
                return "车辆信息接口调用失败！";
            }
            ...
            if (!flag)
            {
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆信息同步", "车辆更新失败");
                return "车辆更新失败";
            }
            DateTime dtEnd = GlobalStaticObj_Server.Instance.CurrentDateTime;//结束时间
        ...
        public static string LoadCustomer(string updateTime)
        {
            ...
            catch (InvalidOperationException ioe)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆客户信息同步", ioe);
                message = ioe.Message;
                return "车辆客户信息同步超时！";
            }
            catch (TimeoutException te)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆客户信息同步", te);
                message = te.Message;
                return "车辆客户信息同步出错！";
            }
            string state = Secret.Decrypt3DES_UTF8(result.state, GlobalStaticObj_YT.KeySecurity_YT);
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆客户信息同步", errMsg);
                return "车辆客户接口调用失败！";
            }
            ...
            if (!flag)
            {
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("车辆客户信息同步", "车辆客户更新失败");
                return "车辆客户更新失败";
            }
            DateTime dtEnd = GlobalStaticObj_Server.Instance.CurrentDateTime;//结束时间
        ...
        public static string LoadRepairProject()
        {
            ...
            catch (InvalidOperationException ioe)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("工时信息同步", ioe);
                message = ioe.Message;
                return "工时信息同步超时！";
            }
            catch (Exception ex)
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("工时信息同步", ex);
                message = ex.Message;
                return "工时信息同步失败！";
            }
            string state = Secret.Decrypt3DES_UTF8(result.state, GlobalStaticObj_YT.KeySecurity_YT);
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("工时信息同步", errMsg);
                return "工时信息调用失败！";
            }
            ...
            if (list.Count > 0)
            {
                ...
                if (!flag)
                {
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("工时信息同步", "工时信息更新失败");
                    return "工时信息更新失败";
                }
            }
            updateCount = projectArr.Count();
            DateTime dtEnd = GlobalStaticObj_Server.Instance.CurrentDateTime;//结束时间
        ...
        public static string LoadProdImprovement(string updateTime)
        {
            ...
            DateTime dtEnd = GlobalStaticObj_Server.Instance.CurrentDateTime;//结束时间
            int totalCount = int.Parse(DBHelper.GetSingleValue("", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.Instance.MainAccCode, "select count(1) from tb_product_no "));
            ...
            WebServUtil.WriteInterficeSyncLog(DataSources.EnumInterfaceType.ProdImprovement, DataSources.EnumExternalSys.YTCRM, DataSources.EnumSyncDirection.DownLoad, "tb_product_no", dtStart, dtEnd, updateCount, message);
            return "";
        }
        #endregion
        ...
        public static string InitData_Contact()
        {
            ...
            process.BackgroundWork = delegate(Action<int> percent)
            {
                ...
                if (!flagDownLoad)
                {
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步联系人信息", "文件下载失败");
                    //return "文件下载失败";
                }
                string fileDir = ZipCompress.UnZipFile(zipFilePath, tempDir, GlobalStaticObj_YT.KeySecurity_YT, ref errMsg);
                if (!string.IsNullOrEmpty(errMsg))
                {
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步联系人信息", errMsg);
                    //return errMsg;
                }
                percent(15);
                ...
                {
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步联系人信息", "文件不存在");
                    //return "文件不存在";
                }
                ...
                if (!flagContact)
                {
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步联系人信息", "联系人更新到数据库失败");
                    //return "联系人更新到数据库失败";
                }
                percent(80);
                DateTime dtEnd = GlobalStaticObj_Server.Instance.CurrentDateTime;//结束时间
            ...
            process.MessageInfo = "正在初始化联系人信息";
            process.Maximum = 100;
        ...
        public static string InitData_Bus()
        {
            ...
            process.BackgroundWork = delegate(Action<int> percent)
            {
                ...
                if (!flagDownLoad)
                {
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步车辆信息", "下载文件失败");
                    //return "下载文件失败";
                ...
                {
                    //return errMsg;
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步车辆信息", errMsg);
                ...
                if (files.Count() == 0)
                {
                    GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步车辆信息", "找不到解压后的json文件！");
                ...
                foreach (string fileName in files)
                {
                    ...
                    int tempCount = 0;
                    bool flagContact = SaveBusNotBatch(bus.busDetails, ref tempCount);
                    ...
                    {
                        //return "车辆更新到数据库失败";
                        GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("全量同步车辆信息", "车辆更新到数据库失败");
                        throw new Exception("车辆更新到数据库失败");
                    }
                }
                DateTime dtEnd = GlobalStaticObj_Server.Instance.CurrentDateTime;//结束时间
                int totalCount = int.Parse(DBHelper.GetSingleValue("", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.Instance.MainAccCode, "select count(1) from tb_vehicle where data_source='2'"));
        ...
        static void process_BackgroundWorkerCompleted(object sender, BackgroundWorkerEventArgs e)
        {
        ...
        private static bool SaveHitchMode(QueryHitchMode.faultPosition[] faultPositionArr, QueryHitchMode.faultMode[] faultModeArr, QueryHitchMode.faultRule[] faultRuleArr, ref int updateCount)
        {
            ...
            dtTbFaultClass.Columns.Add("create_time", typeof(string));
            //故障总成
            ...
            dtTbFaultAssembly.Columns.Add("create_time", typeof(string));
            //故障总成部件
            ...
            dtTbFaultComponent.Columns.Add("create_time", typeof(string));
            ...
            foreach (QueryHitchMode.faultPosition item in faultPositionArr)
            {
                ...
                else
                {
                    ...
                    drAssembly["create_time"] = nowTicks;
            ...
            dtTbFaultModel.Columns.Add("create_time", typeof(string));
            ...
            foreach (QueryHitchMode.faultMode item in faultModeArr)
            {
                ...
                else
                {
                    ...
                    drFaultModel["create_time"] = nowTicks;
            ...
            updateCount += faultPositionArr.Count();
            return flag;
        }
