...
namespace yuTongWebService
{
    public class WebServ_YT_BusiData
    {
        ...
        public static bool LoadOrderStatus(string billNum)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("三包服务单状态查询", billNum);
            //billNum = "BD00000167";
            ServicePointManager.ServerCertificateValidationCallback = WebServUtil.ValidateServerCertificate;
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("三包服务单状态查询", errMsg);
                return false;
            }
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("三包服务单状态查询返回数据", res);
        ...
        public static bool UpLoadPartPutStore(string rationSendCode)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件入库单入库", rationSendCode);
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件入库单入库", errMsg);
                return false;
            }
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件入库单入库返回", Newtonsoft.Json.JsonConvert.SerializeObject(result));
            ...
            string nowDate = Common.LocalDateTimeToUtcLong(GlobalStaticObj_Server.Instance.CurrentDateTime).ToString();//当前时间
            //采购开单住主表
...
where a.purchase_billing_id=@purchase_billing_id";
            ...
            sqlDistribution.Param.Add("create_time", nowDate);
            sqlDistribution.sqlString = @"insert into tb_distribution (distribution_id,ration_send_code,dsn_adjustable_parts,distribution_status,create_time)
                                        values (@distribution_id,@ration_send_code,@dsn_adjustable_parts,@distribution_status,@create_time)";
            ...
            foreach (SUPartPutStore.Detail detail in details)
            {
                ...
                sqlDetail.Param.Add("create_time", nowDate);
                sqlDetail.sqlString = @"insert into tb_distribution_parts (distribution_parts_id,distribution_id,car_parts_code,unit,send_count,create_time)
                                    values (@distribution_parts_id,@distribution_id,@car_parts_code,@unit,@send_count,@create_time)";
            ...
            foreach (SUPartPutStore.Detail detail in details)
            {
                sendCount += Common.ConvertToDecimal(detail.send_count);
            }
            SysSQLString sqlYT = new SysSQLString();
            sqlYT.cmdType = CommandType.Text;
            sqlYT.Param = new Dictionary<string, string>();
            sqlYT.sqlString = string.Format("update tb_parts_purchase_order_2 set send_count=ISNULL(send_count,0)+{0} where crm_bill_id='{1}'", sendCount, dsn_adjustable_parts);
            listSql.Add(sqlYT);
            #endregion
        ...
        public static bool LoadPartInStore(string ration_send_code)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件入库单查询", ration_send_code);
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件入库单查询", mess);
                return false;
            }
            result = WebServUtil.DesModel(result);
            //更新配送单状态为已收货
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件入库单查询返回", Newtonsoft.Json.JsonConvert.SerializeObject(result));
            return true;
        }
        ...
        public static bool LoadPartPurchaseStauts(string crm_bill_id)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件采购单状态查询", string.Format("{0},{1},{2}", crm_bill_id, GlobalStaticObj_YT.SAPCode, GlobalStaticObj_YT.ClientID));
            //如果没有接入码或者sap代码,则不调用接口
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件采购单状态查询", errMsg);
                return false;
            }
            result = WebServUtil.DesModel(result);
            //Utility.Log.Log.writeLineToLog("【配件采购单状态查询】\r\n" + Newtonsoft.Json.JsonConvert.SerializeObject(result), "接口");
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件采购单状态查询返回", Newtonsoft.Json.JsonConvert.SerializeObject(result));
        ...
        public static bool UpLoadPartPurchase(string jsonStr)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件采购单--创建/更新", Newtonsoft.Json.JsonConvert.SerializeObject(purchase));
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件采购单--创建/更新", errMsg);
                return false;
            }
            #region 更新宇通采购单
            bool flag = false;
            try
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("配件采购单--创建/更新返回数据", Newtonsoft.Json.JsonConvert.SerializeObject(result));
        ...
        public static bool UpLoadServiceOrder(string jsonStr)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("三包服务单创建/更新", Newtonsoft.Json.JsonConvert.SerializeObject(orderModel));
            #endregion
            string state = Secret.Decrypt3DES_UTF8(result.state, GlobalStaticObj_YT.KeySecurity_YT);
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("三包服务单创建/更新", errMsg);
            ...
            else
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("三包服务单创建/更新返回数据", Newtonsoft.Json.JsonConvert.SerializeObject(result));
        ...
        public static bool LoadStoreCenter(string carPartsCode)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("宇通中心站-DSN库存查询", carPartsCode);
            ServicePointManager.ServerCertificateValidationCallback = WebServUtil.ValidateServerCertificate;
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("宇通中心站-DSN库存查询", errMsg);
                return false;
            }
        ...
        public static bool QuerySettleAccounts(string settlementNo)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修结算单查询", settlementNo);
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修结算单查询", errMsg);
                return false;
            }
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修结算单查询返回数据", Newtonsoft.Json.JsonConvert.SerializeObject(result));
            //删除云平台缓存,防止重复调用
        ...
        public static bool UpLoadRepairBill(string jsonStr)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修单创建", jsonStr);
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修单创建", errMsg);
                return false;
            }
            return true;
        }
        ...
        public static bool LoadServiceSettleStatus(string settlement_no, string requestType)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修结算单状态查询", settlement_no);
            ServicePointManager.ServerCertificateValidationCallback = WebServUtil.ValidateServerCertificate;
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修结算单状态查询", errMsg);
                return false;
            }
            result = WebServUtil.DesModel(result);
            //Utility.Log.Log.writeLineToLog("【维修结算单状态查询】返回数据\r\n" + Newtonsoft.Json.JsonConvert.SerializeObject(result), "接口");
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("维修结算单状态查询返回数据", Newtonsoft.Json.JsonConvert.SerializeObject(result));
        ...
        public static bool UpPartReturnCreate(string create_time)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-新增", create_time);
            //jsonStr = System.IO.File.ReadAllText("tmp\\repailbill.txt", Encoding.UTF8);
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-新增", errMsg);
                return false;
            }
            result = WebServUtil.DesModel(result);
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-新增返回数据", Newtonsoft.Json.JsonConvert.SerializeObject(result));
        ...
        public static bool LoadPartRetureStatus(string old_bill_num)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-状态查询", old_bill_num);
            ServicePointManager.ServerCertificateValidationCallback = WebServUtil.ValidateServerCertificate;
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-状态查询", errMsg);
                return false;
            }
            result = WebServUtil.DesModel(result);
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-状态查询", Newtonsoft.Json.JsonConvert.SerializeObject(result));
        ...
        public static bool UpPartRetureUpdate(string jsonStr)
        {
            ...
            GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-更新", Newtonsoft.Json.JsonConvert.SerializeObject(model));
            #region 测试数据
            ...
            if (state == "F")
            {
                ...
                GlobalStaticObj_Server.YTInterfaceLogService.WriteLog("旧件回收-更新", errMsg);
                return false;
            }
            else
            {
