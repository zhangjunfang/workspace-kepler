...
namespace CloudPlatSocket
{
    ...
    ///         <datetime>2015/1/27 14:02:31</datetime>
    ...
    public class LogAssistant
    {
        ...
        #region Property -- 属性
        internal static LoggingService _logService;
        internal static LoggingService LogService
        {
            get { return _logService ?? (_logService = CreateLogService("云平台", "Cloud")); }
        }
        internal static LoggingService _logServiceError;
        internal static LoggingService LogServiceError
        {
            get { return _logServiceError ?? (_logServiceError = CreateLogService("本地错误", "Cloud")); }
        }
        #endregion
