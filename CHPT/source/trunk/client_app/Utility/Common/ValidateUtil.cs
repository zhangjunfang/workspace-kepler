...
namespace Utility.Common
{
    ...
    public class ValidateUtil
    {
        ...
        /// <returns></returns>
        public static bool IsBankCard(string card)
        {
            bool flag = Regex.IsMatch(card, @"^[0-9]*$");
            flag = (card.Length == 16 || card.Length == 19);
            return flag;
        }
        ...
        /// <param name="val"></param>
        /// <returns></returns>
        static public bool IsCharNumber(string val)
        {
       ...
       static public bool isnumeric(string str)
        ...
        /// <summary>
        /// 判断是否为0000000000000这类的字符串
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
       static public  bool IsZeroLambda(string str)
        {
            if (!IsZero(str))
            {
                str = str.TrimStart(new char[] { '0' });
                return str.All(new Func<char, bool>((ar) =>
                {
                    if (!ar.Equals('0'))
                    {
                        return false;
       ...
       public static bool IsZero(string str)
        {
