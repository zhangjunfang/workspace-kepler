...
namespace Utility.Common
{
    public abstract class Common
    {
        ...
        /// <returns></returns>
        public static string CurrencyFormat(object obj)
        {
            ...
            decimal currency = 0;
            decimal.TryParse(obj.ToString(), out currency);
            return currency.ToString("N2");
        }

        /// <summary>
        /// 转换成Decimail,如果为空则返回0
        /// </summary>
        /// <param name="obj">要转换在对象</param>
        /// <returns></returns>
        ...
        /// 验证指定数字是否超出指定长度
        /// </summary>
        /// <param name="obj">指定数字</param>
        /// <param name="len">指定长度</param>
        /// <returns>ture表示超出</returns>
        public static bool CheckDecimalLength(object obj, int len)
        {
            if (obj == null || obj == DBNull.Value)
            {
                return false;
