    ...
    public partial class UCCompanyEdit : UCBase
    {
        ...
        void UCCompanyEdit_SaveEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    dicFileds.Add("province", cmbProvince.SelectedValue.ToString());
                }
                else
                {
                    dicFileds.Add("province", "");
                }
                if (cmbCity.SelectedIndex > 0)
                {
                    dicFileds.Add("city", cmbCity.SelectedValue.ToString());
                }
                else
                {
                    dicFileds.Add("city", "");
                ...
                {
                    dicFileds.Add("county", cmbTown.SelectedValue.ToString());
                }
                else
                {
                    dicFileds.Add("county", "");
                }
                ...
                if (windowStatus == WindowStatus.Add)
                {
                    ...
                    dicFileds.Add("data_source", DataSources.EnumDataSources.SELFBUILD.ToString("d"));
                }
                else
                {
                    pkName = "com_id";
