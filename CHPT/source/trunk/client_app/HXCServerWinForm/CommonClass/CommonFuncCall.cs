...
namespace HXCServerWinForm.CommonClass
{
    public class CommonFuncCall
    {
        ...
        public static void BindCompanyComBox(ComboBoxEx cmb, string typename, string com_id)
        {
            List<ListItem> list = new List<ListItem>();
            list.Add(new ListItem("", typename));
            string sqlWhere = "(data_source is null or data_source!=2) and status='1' and enable_flag='1'";
        ...
        public static void BindOrganizeComBox(ComboBoxEx cmb, string companyId, string typename)
        {
            ...
            DataTable dt_Org = DBHelper.GetTable("查询组织信息", GlobalStaticObj_Server.DbPrefix + GlobalStaticObj_Server.CommAccCode, "tb_organization", "org_id,org_name", sqlWhere, "", " order by create_time ");
        ...
        /// <summary> 记录菜单日志
        /// </summary>
        /// <param name="menuRow">菜单数据行</param>
        ...
        public static void LogFunctionCall(string fun_id, string setId = null)
        {
            ...
            FunctionOP_Add.acc_code = GlobalStaticObj_Server.CommAccCode;
