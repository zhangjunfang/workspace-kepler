...
namespace HXCPcClient.LoginForms
{
    public partial class FormLogin : ShadowForm
    {
        ...
        private FormCmb formCmbUserArray = null;
        ...
        public FormLogin()
        {
            ...
            tbDb.InnerTextBox.Top = 3;
            tbPwd.InnerTextBox.Top = 3;
            tbUser.InnerTextBox.Top = 3;
            Load += delegate(object sender, EventArgs args)
            {
                panelTop.Invalidate(true);
            };
        }
        #endregion
        ...
        private void LoginResult(object obj)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //GlobalStaticObj.CurrUserCom_Category = CommonCtrl.IsNullToString(dr.Rows[0]["category"]);  //modify by kord -- 暂时无法获取数据...
                }
                #endregion
                ...
                //GlobalStaticObj.CurrUserCom_Category = CommonCtrl.IsNullToString(HXCPcClient.GlobalStaticObj.gLoginDataSet.Tables[0].Rows[0]["category"]);  //modify by kord -- 暂时无法获取数据...

            }
            catch (Exception ex)
            {
                GlobalStaticObj.GlobalLogService.WriteLog("登录成功加载信息", ex);
            }
        ...
        {
            if (formCmbUserArray != null)
            {
                formCmbUserArray.Visible = !formCmbUserArray.Visible;
                if (formCmbUserArray.Visible)
                {
                    formCmbUserArray.AdjustLocation();
                }
            }
        }
    }
