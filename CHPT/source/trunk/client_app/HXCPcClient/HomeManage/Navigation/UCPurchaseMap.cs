...
namespace HXCPcClient.HomeManage
{
    public partial class UCPurchaseMap : UCView
    {
        ...
        private void UCPurchaseMap_Resize(object sender, EventArgs e)
        {
            lblBsd.Left = miBsd.Left + miBsd.Width / 2;
            lblDbd.Left = miDbd.Left + miDbd.Width / 2;
            lblPdd.Left = miPdd.Left + miPdd.Width / 2;
            lblQtfhd.Left = miQtfhd.Left + miQtfhd.Width / 2;
            lblQtshd.Left = miQtshd.Left + miQtshd.Width / 2;

            lblStock.Left = miDbd.Left + miDbd.Width / 2;
            lblStock.Width = miQtfhd.Left - lblStock.Left + miQtfhd.Width / 2;
        }
    }
}
