...
namespace HXCPcClient.UCForm.RepairBusiness.RepairDispatch
{
    ...
    public partial class UCDispatchManager : UCDispatchBase
    {
        ...
        #region 设置事件
        void UCDispatchManager_SetEvent(object sender, EventArgs e)
        {
        ...
        #region 打印事件
        void UCDispatchManager_PrintEvent(object sender, EventArgs e)
        {
...
//        #endregion
        ...
        public void BindPageData()
        {
            try
            {
                ...
                {
                    strWhere += string.Format(" and  vehicle_model like '%{0}%'", txtCarType.Tag.ToString());   
                }                
        ...
        private void SetSelectedStatus()
        {
            ...
            base.btnVerify.Enabled = listFiles.Contains(HasPassed) || listFiles.Contains(NotPassed) || listFiles.Contains(NotStartWork)  || listFiles.Contains(StartWork) || listFiles.Contains(StopWork) ? false : true;
