...
namespace HXCPcClient.UCForm.RepairBusiness.FetchMaterialReturn
{
    ...
    public partial class UCFMaterialReturnManager : UCBase
    {
        ...
        #region 设置事件
        void UCFMaterialReturnManager_SetEvent(object sender, EventArgs e)
        {
        ...
        #region 导出事件
        void UCFMaterialReturnManager_ExportEvent(object sender, EventArgs e)
        {
            ...
            try
            {
                string fileName = "维修领料退货单" + DateTime.Now.ToString("yyyy-MM-dd") + ".xls";
                ExcelHandler.ExportExcel(fileName, dgvRData);
            }
            catch (Exception ex)
            {
                Utility.Log.Log.writeLineToLog("【维修领料退货单】" + ex.Message, "server");
        ...
        #region 打印事件
        void UCFMaterialReturnManager_PrintEvent(object sender, EventArgs e)
        {
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                Materialadd.strfetchId = MateriaImport.strMaterialId;  //领料单据的Id值
