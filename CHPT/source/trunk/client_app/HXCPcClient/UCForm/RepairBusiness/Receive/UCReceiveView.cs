...
namespace HXCPcClient.UCForm.RepairBusiness.Receive
{
    ...
    public partial class UCReceiveView : UCBase
    {
        ...
        void UCReceiveView_AddEvent(object sender, EventArgs e)
        {
            ...
            deleteMenuByTag(this.Tag.ToString(), ReceiveAdd.Name);
        }
        #endregion
        ...
        void UCReceiveView_CopyEvent(object sender, EventArgs e)
        {
            ...
            deleteMenuByTag(this.Tag.ToString(), ReceiveCopy.Name);
        }
        #endregion
        ...
        void UCReceiveView_EditEvent(object sender, EventArgs e)
        {
            ...
            deleteMenuByTag(this.Tag.ToString(), ReceiveEdit.Name);
        }
        #endregion     
        ...
        private void GetMemberInfo(string strCid)
        {
            ...
            labMemberPZkS.Text = mInfo.strMemberPZk;
            labMemberLZkS.Text = mInfo.strMemberLZk;
        }
        #endregion
