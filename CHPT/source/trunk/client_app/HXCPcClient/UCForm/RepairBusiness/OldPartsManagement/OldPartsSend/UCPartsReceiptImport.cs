    ...
    public partial class UCPartsReceiptImport : FormChooser
    {
        ...
        private void BindData()
        {
            try
            {
                ...
                strWhere = string.Format(" enable_flag='" + Convert.ToInt32(DataSources.EnumEnableFlag.USING).ToString() + "' and (info_status='" + Convert.ToInt32(DataSources.EnumAuditStatus.AUDIT).ToString() + "' or info_status='" + Convert.ToInt32(DataSources.EnumAuditStatus.SUBMIT).ToString() + "') and Import_status='" + Convert.ToInt32(DataSources.EnumImportStaus.OPEN).ToString() + "' and receipt_type ='1'");//enable_flag 1未删除,receipt_type=1表示收货单
