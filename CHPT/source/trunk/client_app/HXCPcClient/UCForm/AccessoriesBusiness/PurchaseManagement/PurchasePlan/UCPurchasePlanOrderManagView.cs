...
namespace HXCPcClient.UCForm.AccessoriesBusiness.PurchaseManagement.PurchasePlan
{
    public partial class UCPurchasePlanOrderManagView : UCBase
    {
        ...
        #region 打印事件
        void UCPurchasePlanOrderManagView_PrintEvent(object sender, EventArgs e)
        {
        ...
        #region 预览事件
        void UCPurchasePlanOrderManagView_ViewEvent(object sender, EventArgs e)
        {
        ...
        #region 导出事件
        void UCPurchasePlanOrderManagView_ExportEvent(object sender, EventArgs e)
        {
            ...
            try
            {
                string fileName = "采购计划单查询" + DateTime.Now.ToString("yyyy-MM-dd") + ".xls";
                ExcelHandler.ExportExcel(fileName, gvPurchasePlanOrderList);
            }
            catch (Exception ex)
            {
                Utility.Log.Log.writeLineToLog("【采购计划单查询】" + ex.Message, "server");
        ...
        #region 预览、打印设置
        void UCPurchasePlanOrderManagView_SetEvent(object sender, EventArgs e)
        {
