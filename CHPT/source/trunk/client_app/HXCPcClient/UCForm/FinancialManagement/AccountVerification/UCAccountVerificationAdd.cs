...
namespace HXCPcClient.UCForm.FinancialManagement.AccountVerification
{
    public partial class UCAccountVerificationAdd : UCBase
    {
        ...
        BusinessDetailPrint detailPrint;//明细打印
        Dictionary<string, DataTable> dicDataTables = new Dictionary<string, DataTable>();
        #endregion
        public UCAccountVerificationAdd(WindowStatus status, string id, UCAccountVerificationManage uc)
        {
            ...
            base.ViewEvent += new ClickHandler(UCAccountVerificationAdd_ViewEvent);
            base.PrintEvent += new ClickHandler(UCAccountVerificationAdd_PrintEvent);
            base.SetEvent += new ClickHandler(UCAccountVerificationAdd_SetEvent);
            ...
            //打印预览
            detailPrint = new BusinessDetailPrint("往来核销");
            //负数格式化红色
            ControlsConfig.NegativeFormatting(dgvDocuments);
            ControlsConfig.NegativeFormatting(dgvDocuments2);
        }
        ...
        private void SetQuick()
        {
            ...
            switch (enumAccount)
            {
                ...
                case DataSources.EnumAccountVerification.YuShouToYuShou://预收转预收
                    //设置客户编码速查
                    txtcCustName1.SetBindTable("tb_customer", "cust_name");
                    txtcCustName2.SetBindTable("tb_customer", "cust_name");
                    break;
                ...
                case DataSources.EnumAccountVerification.YuFuToYuFu://预付转预付
                    //设置供应商编码速查
                    txtcCustName1.SetBindTable("tb_supplier", "sup_full_name");
                    txtcCustName2.SetBindTable("tb_supplier", "sup_full_name");
                    break;
            ...
            txtcCustName1.GetDataSourced -= new TextChooser.GetDataSourceHandler(txtcCustName_GetDataSourced);
            txtcCustName1.GetDataSourced += new TextChooser.GetDataSourceHandler(txtcCustName_GetDataSourced);
            txtcCustName1.DataBacked -= new TextChooser.DataBackHandler(txtcCustName_DataBacked);
            txtcCustName1.DataBacked += new TextChooser.DataBackHandler(txtcCustName_DataBacked);

            txtcCustName2.GetDataSourced -= new TextChooser.GetDataSourceHandler(txtcCustName_GetDataSourced);
            txtcCustName2.GetDataSourced += new TextChooser.GetDataSourceHandler(txtcCustName_GetDataSourced);
            txtcCustName2.DataBacked -= new TextChooser.DataBackHandler(txtcCustName_DataBacked2);
            txtcCustName2.DataBacked += new TextChooser.DataBackHandler(txtcCustName_DataBacked2);
        }

        void txtcCustName_DataBacked(DataRow dr)
        {
            ...
            switch (enumAccount)
            {
                ...
                case DataSources.EnumAccountVerification.YingShouToYingFu://应收冲应付
                case DataSources.EnumAccountVerification.YuShouToYuShou://预收转预收
                    custID = CommonCtrl.IsNullToString(dr["cust_id"]);
                    txtcCustName1.Tag = custID;
                    cust_code1 = CommonCtrl.IsNullToString(dr["cust_code"]);
                    txtcCustName1.Text = CommonCtrl.IsNullToString(dr["cust_name"]);
                    epError.Clear();
                    if (txtcCustName2.Tag == null && enumAccount != DataSources.EnumAccountVerification.YingShouToYingFu)//没有选择应收客户，默认选择与预收客户相同
                    {
                        txtcCustName2.Tag = custID;
                        cust_code2 = cust_code1;
                        txtcCustName2.Text = CommonCtrl.IsNullToString(dr["cust_name"]);
                    }
                ...
                case DataSources.EnumAccountVerification.YingFuToYingShou://应付冲应收
                case DataSources.EnumAccountVerification.YuFuToYuFu://预付转预付
                    custID = CommonCtrl.IsNullToString(dr["sup_id"]);
                    txtcCustName1.Tag = custID;
                    cust_code1 = CommonCtrl.IsNullToString(dr["sup_code"]);
                    txtcCustName1.Text = CommonCtrl.IsNullToString(dr["sup_full_name"]);
                    epError.Clear();
                    if (txtcCustName2.Tag == null && enumAccount != DataSources.EnumAccountVerification.YingFuToYingShou)
                    {
                        txtcCustName2.Tag = custID;
                        cust_code2 = cust_code1;
                        txtcCustName2.Text = CommonCtrl.IsNullToString(dr["sup_full_name"]);
                    }
                    if (txtAdvanceBalance.Visible)
                    {
        ...
        void txtcCustName_DataBacked2(DataRow dr)
        {
            string custID = string.Empty;
            if (cboOrderType.SelectedValue == null)
            {
            ...
            switch (enumAccount)
            {
                ...
                case DataSources.EnumAccountVerification.YingFuToYingShou://应付冲应收
                case DataSources.EnumAccountVerification.YuShouToYuShou://预收转预收
                    txtcCustName2.Tag = CommonCtrl.IsNullToString(dr["cust_id"]);
                    cust_code2 = CommonCtrl.IsNullToString(dr["cust_code"]);
                    txtcCustName2.Text = CommonCtrl.IsNullToString(dr["cust_name"]);
                    break;
                case DataSources.EnumAccountVerification.YuFuToYingFu://预付冲应付
                case DataSources.EnumAccountVerification.YingFuToYingFu://应付转应付
                case DataSources.EnumAccountVerification.YingShouToYingFu://应收冲应付
                case DataSources.EnumAccountVerification.YuFuToYuFu://预付转预付
                    txtcCustName2.Tag = CommonCtrl.IsNullToString(dr["sup_id"]);
                    cust_code2 = CommonCtrl.IsNullToString(dr["sup_code"]);
                    txtcCustName2.Text = CommonCtrl.IsNullToString(dr["sup_full_name"]);
                    break;
            }
            epError.Clear();
        ...
        void txtcCustName_GetDataSourced(TextChooser tc, string sqlString)
        {
            try
            {
                ...
                {
                    string fileds = "cust_id,cust_name,cust_code";
        ...
        //设置
        void UCAccountVerificationAdd_SetEvent(object sender, EventArgs e)
        {
            GetPrintData();
            detailPrint.DetailDesigner(dicDataTables);
        }
        //打印
        void UCAccountVerificationAdd_PrintEvent(object sender, EventArgs e)
        {
            GetPrintData();
            detailPrint.DetailPrint(dicDataTables);
        }
        //预览
        void UCAccountVerificationAdd_ViewEvent(object sender, EventArgs e)
        {
            GetPrintData();
            detailPrint.DetailPreview(dicDataTables);
        }
        ...
        /// <param name="orderID">单据ID列名</param>
        /// <param name="orderName">单据名称列名</param>
        /// <param name="verification_money">冲销金额</param>
        /// <returns></returns>
        bool CheckDetail(DataGridViewEx dgv, string colName, string colWaitMoneyName, string orderID, string orderName, ref decimal verification_money)
        {
            if (!dgv.Visible)
            {
                return true;
            ...
            else if (dgv.AllowUserToAddRows && dgv.Rows.Count == 1)
            {
            ...
            foreach (DataGridViewRow dgvr in dgv.Rows)
            {
                ...
                DataSources.EnumAccountVerification orderType = (DataSources.EnumAccountVerification)Convert.ToInt32(cboOrderType.SelectedValue);
                if (waitMoney.Length == 0)
                {
                    //预付转预付,预收转预收不必有待结算,其它必须有待结算
                    if (orderType != DataSources.EnumAccountVerification.YuFuToYuFu && orderType != DataSources.EnumAccountVerification.YuShouToYuShou)
                    {
                        return true;
                    }
                }
                ...
                else if (Common.CheckDecimalLength(nameNum, 13))
                {
                    MessageBoxEx.ShowError("本次核销超出系统限制，请检查输入！");
                    dgv.CurrentCell = dgvr.Cells[colName];
                    check = false;
                    break;
                }
                //预付转预付,预收转预收不必比较待结算,其它待结算=本次核销
                if (orderType != DataSources.EnumAccountVerification.YuFuToYuFu && orderType != DataSources.EnumAccountVerification.YuShouToYuShou)
                {
                    string documentID = CommonCtrl.IsNullToString(dgvr.Cells[orderID].Value);//单据ID
                    string documentType = CommonCtrl.IsNullToString(dgvr.Cells[orderName].Value);//单据名称
                    if (!Financial.CheckDocument(documentID, documentType, decimal.Parse(nameNum)))
                    {
        ...
        void AddAccountVerificationSqlString(List<SysSQLString> list, DataSources.EnumAuditStatus auditStatus, decimal verification_money)
        {
            ...
            sql.Param.Add("advance_balance", string.IsNullOrEmpty(advance) ? null : advance.Replace(",", ""));//预收余额
...
,@create_by,@create_time)";
        ...
        void GetPrintData()
        {
            ...
            dtVerification.Columns.Add("order_num");
            dtVerification.Columns.Add("order_date");
            dtVerification.Columns.Add("order_status");
            dtVerification.Columns.Add("order_type");
            dtVerification.Columns.Add("cust_name1");
            dtVerification.Columns.Add("cust_name2");
            dtVerification.Columns.Add("advance_balance");
            dtVerification.Columns.Add("dealings_balance");
            dtVerification.Columns.Add("bank_of_deposit");
            dtVerification.Columns.Add("bank_account");
            dtVerification.Columns.Add("remark");
            dtVerification.Columns.Add("org_name");
            dtVerification.Columns.Add("handle_name");
            dtVerification.Columns.Add("operator_name");
            dtVerification.Columns.Add("create_name");
            dtVerification.Columns.Add("create_time");
            dtVerification.Columns.Add("update_name");
            dtVerification.Columns.Add("update_time");
            dtVerification.Columns.Add("print_name");
            DataRow drVerification = dtVerification.NewRow();
            drVerification["order_num"] = txtOrderNum.Caption;
            drVerification["order_date"] = dtpOrderDate.Value.ToString("yyyy-MM-dd");
            drVerification["order_status"] = txtOrderStatus.Caption;
            drVerification["order_type"] = cboOrderType.Text;
            drVerification["cust_name1"] = txtcCustName1.Text;
            drVerification["cust_name2"] = txtcCustName2.Text;
            drVerification["advance_balance"] = txtAdvanceBalance.Caption;
            drVerification["remark"] = txtRemark.Caption;
            drVerification["org_name"] = cboOrgId.Text;
            drVerification["handle_name"] = cboHandle.Text;
            drVerification["operator_name"] = lblOperator.Text;
            drVerification["create_name"] = lblCreateBy.Text;
            drVerification["create_time"] = lblCreateTime.Text;
            drVerification["update_name"] = lblUpdateBy.Text;
            drVerification["update_time"] = lblUpdateTime.Text;
            drVerification["print_name"] = GlobalStaticObj.UserName;
            dtVerification.Rows.Add(drVerification);
            dicDataTables.Add("tb_account_verification", dtVerification);
            #endregion
            DataSources.EnumAccountVerification enumAccount = (DataSources.EnumAccountVerification)Convert.ToInt32(cboOrderType.SelectedValue);
            if (enumAccount == DataSources.EnumAccountVerification.YingShouToYingFu)
            {
                dicDataTables.Add("tb_verificationn_documents1", dgvDocuments2.GetBoundData());
                dicDataTables.Add("tb_verificationn_documents2", dgvDocuments.GetBoundData());
            }
            else if (enumAccount == DataSources.EnumAccountVerification.YingFuToYingShou)
            {
                dicDataTables.Add("tb_verificationn_documents1", dgvDocuments.GetBoundData());
                dicDataTables.Add("tb_verificationn_documents2", dgvDocuments2.GetBoundData());
            }
            else
            {
                dicDataTables.Add("tb_verificationn_documents1", dgvDocuments.GetBoundData());
            }
            detailPrint.PrintTitle = cboOrderType.Text;
        }
        /// <summary>
        /// 解除占用前置单据
        /// </summary>
        ...
        void Save(DataSources.EnumAuditStatus auditStatus)
        {
            ...
            if (!CheckAccountVerification() || !CheckDetail(dgvDocuments, colVerificationMoney.Name, colWaitMoney.Name, colOrderID.Name, colOrderName.Name, ref verification_money)
                || !CheckDetail(dgvDocuments2, colVerificationMoney2.Name, colWaitMoney2.Name, colOrderID2.Name, colOrderName2.Name, ref verification_money) || !CheckTotal() || !CheckYuE(auditStatus))
            {
                return;
            }
...
where a.order_status in ('1','2') and b.order_id=purchase_billing_id
        ...
        //绑定明细
        void BindDetail(DataSources.EnumAuditStatus enumAuditStatus)
        {
            if (cboOrderType.SelectedValue == null)
            {
                return;
            ...
            if (enumAccount == DataSources.EnumAccountVerification.YingShouToYingFu)
            {
                ...
                BindDocuments(listYS, enumAuditStatus);
                BindDocuments2(listYF, enumAuditStatus);
                dicDataTables.Add("tb_verificationn_documents1", listYS.CopyToDataTable());
                dicDataTables.Add("tb_verificationn_documents2", listYF.CopyToDataTable());
            }
            else if (enumAccount == DataSources.EnumAccountVerification.YingFuToYingShou)
            {
                DataRow[] listYS = dt.Select("order_index='2'");
                List<DataRow> listYF = dt.Select("order_index='1'").ToList();
                BindDocuments(listYF, enumAuditStatus);
                BindDocuments2(listYS, enumAuditStatus);
                dicDataTables.Add("tb_verificationn_documents1", listYF.CopyToDataTable());
                dicDataTables.Add("tb_verificationn_documents2", listYS.CopyToDataTable());
            }
            else
            {
                List<DataRow> list = dt.Rows.Cast<DataRow>().ToList();
                BindDocuments(list, enumAuditStatus);
                dicDataTables.Add("tb_verificationn_documents1", dt);
            }
        }
        /// <summary>
        /// 绑定第一个
        ...
        void BindDocuments(List<DataRow> drs, DataSources.EnumAuditStatus enumAuditStatus)
        {
            dgvDocuments.Rows.Clear();
            foreach (DataRow dr in drs)
            {
                ...
                dgvr.Cells[colOrderDate.Name].Value = dr["order_date"];
                dgvr.Cells[colMoney.Name].Value = dr["money"];

                decimal money = Common.ConvertToDecimal(dr["money"]);//总金额
                decimal settledMoney = Common.ConvertToDecimal(dr["settled_money"]);//已结算金额
                string documentID = CommonCtrl.IsNullToString(dr["order_id"]);
                string documentName = CommonCtrl.IsNullToString(dr["order_name"]);
                if ((enumAuditStatus == DataSources.EnumAuditStatus.DRAFT || enumAuditStatus == DataSources.EnumAuditStatus.NOTAUDIT)
                    && documentID.Length > 0 && documentName.Length > 0)
                {
                    decimal waitMoney = Financial.GetDocumentWaitMoney(documentID, documentName);
                    dgvr.Cells[colWaitMoney.Name].Value = waitMoney;//待结算
                    dgvr.Cells[colSettledMoney.Name].Value = money - waitMoney;//已结算
                }
                else
                {
                    dgvr.Cells[colSettledMoney.Name].Value = dr["settled_money"];//已结算
                    dgvr.Cells[colWaitMoney.Name].Value = money - settledMoney;//待结算
                }
        ...
        /// </summary>
        /// <param name="drs"></param>
        void BindDocuments2(DataRow[] drs, DataSources.EnumAuditStatus enumAuditStatus)
        {
            dgvDocuments2.Rows.Clear();
            foreach (DataRow dr in drs)
            {
                ...
                dgvr.Cells[colOrderDate2.Name].Value = dr["order_date"];
                ...
                {
                    decimal waitMoney = Financial.GetDocumentWaitMoney(documentID, documentName);
                    dgvr.Cells[colWaitMoney2.Name].Value = waitMoney;//待结算
                    dgvr.Cells[colSettledMoney2.Name].Value = money - waitMoney;//已结算
                }
                else
                {
                    dgvr.Cells[colWaitMoney2.Name].Value = money - settledMoney;//待结算
                    dgvr.Cells[colSettledMoney2.Name].Value = dr["settled_money"];//已结算
                }
            ...
            switch (enumAccount)
            {
                ...
                case DataSources.EnumAccountVerification.YuShouToYuShou://预收转预收
                    ...
                    if (frmCustomer.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        if (txtAdvanceBalance.Visible)
                        {
                            txtAdvanceBalance.Caption = DBOperation.GetAdvance(frmCustomer.strCustomerId, DataSources.EnumOrderType.RECEIVABLE).ToString("N2");
                        }
                    }
                    break;
                case DataSources.EnumAccountVerification.YuFuToYingFu://预付冲应付
                ...
                case DataSources.EnumAccountVerification.YuFuToYuFu://预付转预付
                    ...
                    if (frmSupp.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        if (txtAdvanceBalance.Visible)
                        {
                            txtAdvanceBalance.Caption = DBOperation.GetAdvance(frmSupp.supperID, DataSources.EnumOrderType.PAYMENT).ToString("N2");
                        }
                    }
                    break;
            }
        ...
        private void UCAccountVerificationAdd_SizeChanged(object sender, EventArgs e)
        {
            string[] total = { colVerificationMoney.Name, colMoney.Name, colSettledMoney.Name, colWaitMoney.Name };
            ControlsConfig.DatagGridViewTotalConfig(dgvDocuments, total);
            string[] total2 = { colVerificationMoney2.Name, colMoney2.Name, colSettledMoney2.Name, colWaitMoney2.Name };
            ControlsConfig.DatagGridViewTotalConfig(dgvDocuments2, total2);
        }
