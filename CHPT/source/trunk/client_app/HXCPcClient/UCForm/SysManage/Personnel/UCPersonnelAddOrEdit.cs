...
namespace HXCPcClient.UCForm.SysManage.Personnel
{
    ...
    public partial class UCPersonnelAddOrEdit : UCBase
    {
        ...
        public delegate RespFunStruct UpdateDele(string opname, EnumWebServFunName webfunname, object obj);
        public RefreshData RefreshDataStart;
        public UpdateDele Update;
        #endregion
        ...
        //组织ID
        public string org_id = string.Empty;
        //公司名称
        public string com_name = string.Empty;
        #endregion
        ...
        private void UCPersonnelAddOrEdit_Load(object sender, EventArgs e)
        {
            ...
            this.InitData();
            if (windowStatus == WindowStatus.Add && org_name != string.Empty && org_id != string.Empty && com_name != string.Empty)
            {
                txtcom_name.Caption = com_name;
                txcorg_name.Text = org_name;
                txcorg_name.Tag = org_id;
        ...
        private void SetBtnStatus()
        {
            ...
            {
                SetSysManageEditBtn();
                if (dr["status"].ToString() == ((int)DataSources.EnumStatus.Start).ToString())
                {
        ...
        private void InitEvent()
        {
            ...
            base.StatusEvent += new ClickHandler(UCPersonnelAddOrEdit_StatusEvent);
            base.DeleteEvent += new ClickHandler(UCPersonnelAddOrEdit_DeleteEvent);
        }
        ...
        private void InitData()
        {
            ...
            CommonFuncCall.BindComBoxDataSource(cbonation, "nation_yt", "请选择");//绑定民族
            cbonation.Text = "汉族";
            ...
            DataTable dtRole = DBHelper.GetTable("查询角色", "sys_role", "role_id,role_name", " enable_flag='1' and state='1'", string.Empty, string.Empty);
            cborole.DataSource = dtRole;
            cborole.ValueMember = "role_id";
            cborole.DisplayMember = "role_name";
            //CommonFuncCall.BindComBoxDataSource(cboClass, "sys_personnel_level", "请选择");
        ...
        private void BindControls()
        {
            ...
            if (cbois_operator.SelectedValue.ToString() == "1")
            {
                ...
                txtPassWord.Caption = this.dr["password"].ToString();
            }
            else
            ...
            if (dt_pic != null && dt_pic.Rows.Count > 0)
            {
                ...
                picuser.Image = FileOperation.DownLoadImage(photoPath);
            }
            BindAData("sys_user", id);
            string roleid = DBHelper.GetSingleValue("查询用户角色", "tr_user_role", "role_id", "user_id='" + dr["user_id"].ToString() + "'", string.Empty);
        ...
        private bool Validator(ref string msg)
        {
            ...
            if (cbosex.SelectedValue == null || cbosex.SelectedValue.ToString().Length == 0)
            {
            ...
            if (LocalCache.GetDictNameById(cboidcard_type.SelectedValue.ToString()) == "身份证")
            {
                if (!txtidcard_num.Verify())
                {
                    //Utility.Common.Validator.SetError(errorProvider1, txtidcard_num, "请输入正确身份证!");
                    return false;
                }
            }
            ...
            if (cbois_operator.SelectedValue.ToString() == "1")
            {
                ...
                if (WindowStatus.Add == this.windowStatus
        ...
        void UCPersonnelAddOrEdit_SaveEvent(object sender, EventArgs e)
        {
            ...
            dicFileds.Add("nation", CommonCtrl.IsNullToString(this.cbonation.SelectedValue));//民族 
            ...
            if (bln)
            {
                if (windowStatus == WindowStatus.Add || windowStatus == WindowStatus.Edit)
                {
                    ...
                    var cont = new tb_contacts_ex
                           {
                               ...
                               nation = CommonCtrl.IsNullToString(this.cbonation.SelectedValue),
                ...
                if (cbois_operator.SelectedValue.ToString() == "1" && cborole.SelectedValue == null)
                {
                    MessageBoxEx.Show("请选择操作员角色!", "提示", MessageBoxButtons.OK, MessageBoxIcon.None);
                    return;
                }
                DeleteUserRole(currUser_id);
                //如果是操作员
                if (cbois_operator.SelectedValue.ToString() == "1")
                {


                    AddUserRole(cborole.SelectedValue.ToString(), currUser_id);
                }
        ...
        private void cbois_operator_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbois_operator.SelectedValue.ToString() == "1")
            {
                ...
                txtland_name.Visible = true;
                lbltipland.Visible = true;
            ...
            else
            {
                ...
                txtland_name.Visible = false;
                lbltipland.Visible = false;
        ...
        private void llbDetele_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                if (DBHelper.BatchDeleteDataByWhere("删除人员档案图片", "attachment_info", string.Format("att_id='{0}'", photoID)))
                {
                    picuser.Image = null;
                    picuser.Tag = null;
        ...
        void UCPersonnelAddOrEdit_DeleteEvent(object sender, EventArgs e)
        {
            Delete();
        }

        void UCPersonnelAddOrEdit_StatusEvent(object sender, EventArgs e)
        {
            SetStatus();
        }
        ...
        private bool StatusSql()
        {
            ...
            return DBHelper.Submit_AddOrEdit(btnStatus.Caption + "人员", "sys_user", "user_id", dr["user_id"].ToString(), status);
        }
        ...
        private void Delete()
        {
            if (MessageBoxEx.Show("是否要删除当前数据？", "提示", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                ...
                if (DBHelper.Submit_AddOrEdit("删除人员", "sys_user", "user_id", dr["user_id"].ToString(), updateField))
                {
                    MessageBoxEx.Show("删除成功！");
                    DeleteUserRole(dr["user_id"].ToString());
                    UploadUserData();
                    deleteMenuByTag(this.Tag.ToString(), this.parentName);
