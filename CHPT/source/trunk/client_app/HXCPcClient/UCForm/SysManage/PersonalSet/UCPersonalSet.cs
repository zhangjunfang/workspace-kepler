...
namespace HXCPcClient.UCForm.SysManage.PersonalSet
{
    ...
    public partial class UCPersonalSet : UCBase
    {
        ...
        private void BindControls(DataTable dt)
        {
            ...
            {
                this.cbonation.SelectedValue = string.Empty;
            }
            ...
            //附件信息数据
            ucAttachment1.TableNameKeyValue = GlobalStaticObj.UserID;
            ucAttachment1.TableName = "sys_user";
            ucAttachment1.BindAttachment();
        }
        #endregion
        ...
        void UCPersonalSet_SaveEvent(object sender, EventArgs e)
        {
            ...
            { 
                ...
                try
                {
                    ...
                    if (!ucAttachment1.CheckAttachment())
                    {
                        return;
                    }
                    ...
                    dicFileds.Add("education", CommonCtrl.IsNullToString(cboeducation.SelectedValue.ToString()));//学历
                    ...
                    //新增加的用户的ID
                    ucAttachment1.TableNameKeyValue = keyValue;
                    ucAttachment1.TableName = "sys_user";
                    List<SysSQLString> Sql=new List<SysSQLString> ();

                    ucAttachment1.GetAttachmentSql(Sql);

                    bool flag = DBHelper.BatchExeSQLStringMultiByTrans("添加人员附件信息", Sql);
        ...
        private void txcorg_name_ChooserClick(object sender, EventArgs e)
        {
            ...
            {
                //txcorg_name.c = frmModels.Com_Name;
