...
namespace HXCPcClient.UCForm.SysManage.Company
{
    ...
    public partial class UCCompanyAddOrEdit : UCBase
    {
        ...
        public UCCompanyAddOrEdit(WindowStatus winStatus, DataRow dr, string parentName, UCCompanyManager parentFrm)
        {
            InitializeComponent();
            ...
            base.StatusEvent += new ClickHandler(UCCompanyAddOrEdit_StatusEvent);
            base.DeleteEvent += new ClickHandler(UCCompanyAddOrEdit_DeleteEvent);
        ...
        private void txttax_account_KeyPress(object sender, KeyPressEventArgs e)
        {
            OnlyNum(e);
        }
        ...
        void UCCompanyAddOrEdit_StatusEvent(object sender, EventArgs e)
        {
            SetStatus();
        }
        ...
        private bool StatusSql()
        {
            ...
            return DBHelper.Submit_AddOrEdit(btnStatus.Caption + "公司", "tb_company", "com_id", dr["com_id"].ToString(), status);
        }
        ...
        void UCCompanyAddOrEdit_DeleteEvent(object sender, EventArgs e)
        {
            DeleteCom();
        }
