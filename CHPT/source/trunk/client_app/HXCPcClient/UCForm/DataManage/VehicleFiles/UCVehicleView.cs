...
namespace HXCPcClient.UCForm.DataManage.VehicleFiles
{
    ...
    public partial class UCVehicleView : UCBase
    {
        ...
        void UCVehicleView_CopyEvent(object sender, EventArgs e)
        {
            ...
            Copy.strId = strVId;
            base.addUserControl(Copy, "领料单-复制", "Copy" + Copy.strId, this.Tag.ToString(), this.Name);
            deleteMenuByTag(this.Tag.ToString(), Copy.Name);
        }
        #endregion
        ...
        void UCVehicleView_EditEvent(object sender, EventArgs e)
        {
            ...
            Edit.strId = strVId;
            base.addUserControl(Edit, "车辆档案-编辑", "Edit" + Edit.strId, this.Tag.ToString(), this.Name);
            deleteMenuByTag(this.Tag.ToString(), Edit.Name);
        }
        #endregion
        ...
        void UCVehicleView_AddEvent(object sender, EventArgs e)
        {
            ...
            base.addUserControl(Add, "车辆档案-新增", "Add" + Add.strId, this.Tag.ToString(), this.Name);
            deleteMenuByTag(this.Tag.ToString(), Add.Name);
        }
        #endregion
