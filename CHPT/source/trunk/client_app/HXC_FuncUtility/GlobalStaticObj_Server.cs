...
namespace HXC_FuncUtility
{
    ...
    public class GlobalStaticObj_Server
    {
        ...
        /// <summary> 数据连接日志
        /// </summary>
        public static LoggingService DbConnLogService = Log.CreateLogService("dbconn", "dbconn");
        /// <summary> wcf日志
        /// </summary>
        public static LoggingService WCFLogService = Log.CreateLogService("wcf", "wcf");
        /// <summary> 云平台通讯日志
        /// </summary>
        public static LoggingService CloudPadLogService = Log.CreateLogService("cloudpad", "cloudpad");
        /// <summary> 宇通接口日志
        /// </summary>
        public static LoggingService YTInterfaceLogService = Log.CreateLogService("ytinterface", "ytinterface");
        #endregion
        ...
        /// </summary>
        public string DbTemplateBakFileName = "HXC_001";
        #endregion
        ...
        /// 数据库连接状态
        /// </summary>
        public static bool ConnStatus = true;
        #endregion
        ...
        /// Ticks字符串
        /// </summary>
        public string UserUploadTime = DateTime.Now.Ticks.ToString();
        #endregion
                ...
                if (null == _instance)
                {
                    lock (SynObject)
                    {
                        if (null == _instance)
                        {
                            ...
                            _instance.CloundServerIp = ConfigurationManager.AppSettings["CloundDataIP"];
                            _instance.CloundServerPort = Convert.ToInt32(ConfigurationManager.AppSettings["CloundDataPort"]);
                            _instance.CloundFileIp = ConfigurationManager.AppSettings["CloundFileIP"];
                            _instance.CloundFilePort = Convert.ToInt32(ConfigurationManager.AppSettings["CloundFilePort"]);                        
