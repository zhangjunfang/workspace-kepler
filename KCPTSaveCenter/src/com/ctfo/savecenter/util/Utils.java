...
import com.ctfo.savecenter.Const;
...
public class Utils {
	...
	public static Long getSpeed(Map<String, String> app){
		try{
			if(app.get(Constant.SPEEDFROM).equals(Const.P0)){// 0：来自VSS
				return Long.parseLong(app.get(Const.P7));
			}else{
				return Long.parseLong(app.get(Const.P3));
			}
		}catch(Exception e){
			return 0l;
		}
