 ...
 * 设置终端事件指令应答
 */
public class SetTerminalEventResp extends InsideMsgResp {

	public static final String COMMAND = "D_SETP_UP";

	private String status;
	
	public SetTerminalEventResp(){
	...
	public String toString() {
		return "CAITR " + InsideMsgUtils.getCommandSeq() + " " + this.getOemId()+"_"+this.getDeviceNo()
