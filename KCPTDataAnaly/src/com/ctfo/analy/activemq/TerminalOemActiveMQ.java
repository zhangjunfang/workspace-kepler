 ...
 * <li>文件名称：TerminalOemActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  上午10:07:58	</li><br>
 * <li>描        述：终端协议频道			</li><br>
 *****************************************/
public class TerminalOemActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(TerminalOemActiveMQ.class);
	...
	public TerminalOemActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
