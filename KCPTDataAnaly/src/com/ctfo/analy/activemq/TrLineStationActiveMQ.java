 ...
 * <li>文件名称：VehicleLineActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:59:09	</li><br>
 * <li>描        述：车辆线路频道			</li><br>
 *****************************************/
public class TrLineStationActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(TrLineStationActiveMQ.class);
	...
	public TrLineStationActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
	...
	private void processMsg(String msg) {
		...
		if(msgStr.length == 3){
			...
			if(type.equals("ADD")){
				//车辆线路报警设置
				cacheUpdateDBAdapter.queryLineStationCfg();
			//批量导入  全量导入通知与车辆线路相关的缓存更新 
