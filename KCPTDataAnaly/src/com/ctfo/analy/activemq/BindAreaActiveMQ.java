 ...
 * <li>文件名称：BindAreaActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:53:42	</li><br>
 * <li>描        述：区域绑定频道			</li><br>
 *****************************************/
public class BindAreaActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(BindAreaActiveMQ.class);
	...
	public BindAreaActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
