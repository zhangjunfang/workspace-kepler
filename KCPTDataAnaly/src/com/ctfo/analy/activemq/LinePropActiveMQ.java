 ...
 * <li>文件名称：LinePropActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:54:31	</li><br>
 * <li>描        述：线路频道			</li><br>
 *****************************************/
public class LinePropActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(LinePropActiveMQ.class);
	...
	public LinePropActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
