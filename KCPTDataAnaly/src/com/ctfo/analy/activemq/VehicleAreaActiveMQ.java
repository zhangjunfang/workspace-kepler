 ...
 *****************************************/
public class VehicleAreaActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(VehicleAreaActiveMQ.class);
	...
	public VehicleAreaActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
