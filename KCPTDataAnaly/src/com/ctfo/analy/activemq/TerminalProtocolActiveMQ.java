 ...
 * <li>文件名称：TerminalProtocolActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  上午10:07:38	</li><br>
 * <li>描        述：设备厂商频道			</li><br>
 *****************************************/
public class TerminalProtocolActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(TerminalProtocolActiveMQ.class);
	...
	public TerminalProtocolActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
