 ...
 * <li>文件名称：com.ctfo.analy.activemq </li><br>
 * <li>时        间：2013-5-9  下午12:52:16	</li><br>
 * <li>描        述：TODO			</li><br>
 *****************************************/
 ...
 * <li>文件名称：SectioncActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:52:16	</li><br>
 * <li>描        述：车辆区间频道			</li><br>
 *****************************************/
public class SectioncfgActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(SectioncfgActiveMQ.class);
	...
	public SectioncfgActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
