 ...
 * <li>文件名称：AlarmNoticeActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:55:08	</li><br>
 * <li>描        述：告警自动下发频道			</li><br>
 *****************************************/
public class AlarmNoticeActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(AlarmNoticeActiveMQ.class);
	...
	public AlarmNoticeActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
...
//				cacheUpdateDBAdapter.vehicleAlarmDelete(value);
			}else{
	...
	public void interrupt() {
		try {
			...
			logger.error("关闭告警自动下发信息总线线程异常:", e);
		}
	}
