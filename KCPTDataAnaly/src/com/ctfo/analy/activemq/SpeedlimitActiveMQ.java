 ...
 * <li>文件名称：SpeedlimitActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:53:20	</li><br>
 * <li>描        述：车辆限速频道			</li><br>
 *****************************************/
public class SpeedlimitActiveMQ extends CreateActiveMQ {

	private static final Logger logger = Logger.getLogger(SpeedlimitActiveMQ.class);
	...
	public SpeedlimitActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
	...
	private void processMsg(String msg) {
		...
		if(msgStr.length == 3){
			...
			String name = " tss.config_id ";
			String value = (msgStr[2].split(":"))[1];
			//通知与车辆限速相关的缓存更新
			if(type.equals("ADD")){
				//车辆限速报警设置
				cacheUpdateDBAdapter.roadAlarmUpdate(name, value);
			//批量导入  全量导入通知与车辆限速相关的缓存更新 
			}else if (type.equals("BULKADD")){
				cacheUpdateDBAdapter.roadAlarmBlukAdd();		
			//通知与车辆限速相关的缓存更新 
