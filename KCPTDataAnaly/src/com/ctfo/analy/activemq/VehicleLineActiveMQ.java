 ...
 * <li>描        述：车辆线路频道			</li><br>
 *****************************************/
public class VehicleLineActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(VehicleLineActiveMQ.class);
	...
	public VehicleLineActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
