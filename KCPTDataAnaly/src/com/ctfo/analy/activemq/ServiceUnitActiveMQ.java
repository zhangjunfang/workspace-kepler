 ...
 * <li>文件名称：ServiceUnitActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  上午10:05:40	</li><br>
 * <li>描        述：服务关系频道			</li><br>
 *****************************************/
public class ServiceUnitActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(ServiceUnitActiveMQ.class);
	...
	public ServiceUnitActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
