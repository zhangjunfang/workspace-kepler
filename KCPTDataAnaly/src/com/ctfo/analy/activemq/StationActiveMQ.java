 ...
 * <li>文件名称：StationActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:54:44	</li><br>
 * <li>描        述：站点频道			</li><br>
 *****************************************/
public class StationActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(StationActiveMQ.class);
	...
	public StationActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
