 ...
 * <li>文件名称：TrAreaActiveMQ.java </li><br>
 * <li>时        间：2013-5-9  下午12:54:14	</li><br>
 * <li>描        述：区域关系频道			</li><br>
 *****************************************/
public class TrAreaActiveMQ extends CreateActiveMQ {
	private static final Logger logger = Logger.getLogger(TrAreaActiveMQ.class);
	...
	public TrAreaActiveMQ(String mqUrl, String queueName, XmlConf config) {
		super.mqUrl = mqUrl;
