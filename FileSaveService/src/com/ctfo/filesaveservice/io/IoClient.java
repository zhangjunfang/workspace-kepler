...
public class IoClient {
	...
	/** 空闲间隔 */
	private static long CONNECT_TIMEOUT = 60 * 1000L; // 30 seconds
	 ...
	 */
	public IoClient() {
		this.host = ConfigLoader.fileParamMap.get("msgLoginIp");
		this.port = Integer.parseInt(ConfigLoader.fileParamMap.get("msgLoginPort"));
...
//		断线重连回调过滤器
		...
		// 读写通道10s内无操作,则进入空闲状
		connector.getSessionConfig().setIdleTime(IdleStatus.WRITER_IDLE, 45);
