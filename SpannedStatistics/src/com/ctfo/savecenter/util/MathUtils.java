...
public class MathUtils {
	protected static Logger logger = LoggerFactory.getLogger(MathUtils.class);
	...
	public static boolean checkValue(StatusBean statusBean,double value){
		if(statusBean.getMin() <= value && statusBean.getMax() >= value){
			return true;
		}
		return false;
	}
	
	public static boolean checkEWaterValue(StatusBean statusBean,double value){
		if(-100000 <= value && statusBean.getMax() >= value){
			return true;
		}
		return false;
	}
