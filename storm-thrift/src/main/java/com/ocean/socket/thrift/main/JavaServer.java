package com.ocean.socket.thrift.main;
...
import com.ocean.socket.thrift.handle.CalculatorHandler;
import com.ocean.socket.thrift.server.Calculator;
...
public class JavaServer {
	...
	public static void main(String[] args) {
		Calculator.Processor<CalculatorHandler> processor;
		try {
