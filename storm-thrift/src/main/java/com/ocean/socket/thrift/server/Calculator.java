...
public class Calculator {
	...
	public interface Iface extends
			com.ocean.socket.thrift.common.SharedService.Iface {
	...
	public interface AsyncIface extends
			com.ocean.socket.thrift.common.SharedService.AsyncIface {
		...
		public void calculate(int logid, Work w,
				org.apache.thrift.async.AsyncMethodCallback resultHandler)
				throws org.apache.thrift.TException;
	...
	public static class Client extends
			com.ocean.socket.thrift.common.SharedService.Client implements
			Iface {
	...
	public static class AsyncClient extends
			com.ocean.socket.thrift.common.SharedService.AsyncClient implements
			AsyncIface {
		public static class Factory implements
		...
		public static class zip_call extends
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot)
					throws org.apache.thrift.TException {
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage(
						"zip", org.apache.thrift.protocol.TMessageType.ONEWAY,
						0));
				zip_args args = new zip_args();
				args.write(prot);
				prot.writeMessageEnd();
	...
	public static class Processor<I extends Iface> extends
			com.ocean.socket.thrift.common.SharedService.Processor<I> implements
	...
	public static class AsyncProcessor<I extends AsyncIface> extends
			com.ocean.socket.thrift.common.SharedService.AsyncProcessor<I> {
	...
	public static class calculate_args implements
		...
		public int compareTo(calculate_args other) {
			...
			lastComparison = Boolean.valueOf(isSetW())
					.compareTo(other.isSetW());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetW()) {
	...
	public static class zip_args implements
			...
			java.io.Serializable, Cloneable, Comparable<zip_args> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"zip_args");
