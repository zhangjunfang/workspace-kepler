...
public class TridentReach {
  public static Map<String, List<String>> TWEETERS_DB = new HashMap<String, List<String>>() {/**
	 * 
	 */
	private static final long serialVersionUID = 4961652952566016482L;

{
  ...
  public static Map<String, List<String>> FOLLOWERS_DB = new HashMap<String, List<String>>() {/**
	 * 
	 */
	private static final long serialVersionUID = 7547066717528609345L;

{
  ...
  public static class StaticSingleKeyMapState extends ReadOnlyState implements ReadOnlyMapState<Object> {
    public static class Factory implements StateFactory {
      /**
		 * 
		 */
		private static final long serialVersionUID = 7137152077627115900L;
  ...
  public static class One implements CombinerAggregator<Integer> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8407495905352015531L;
  ...
  public static class ExpandList extends BaseFunction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8717618386997667152L;
