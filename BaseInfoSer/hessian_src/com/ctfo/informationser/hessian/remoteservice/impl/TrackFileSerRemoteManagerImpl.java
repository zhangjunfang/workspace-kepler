 ...
 */
package com.ctfo.informationser.hessian.remoteservice.impl;

import com.ctfo.hessian.service.HessianServer;
import com.ctfo.informationser.hessian.remote.HessianRemoteAbstract;
import com.ctfo.informationser.hessian.remoteservice.TrackFileSerRemoteManager;
 ...
 * @since JDK1.6
 */
public class TrackFileSerRemoteManagerImpl extends HessianRemoteAbstract implements TrackFileSerRemoteManager {

//	private static Log log = LogFactory.getLog(TrackFileSerRemoteManagerImpl.class);
