...
public abstract class HessianRemoteAbstract implements HessianRemote {
	...
	private static Log log = LogFactory.getLog(HessianRemoteAbstract.class);
	...
	public Object execute(HessianServer hessianServer, Object... params) throws CtfoAppException {
		...
		if (params == null) {
			try {
				Object obj = hessianServer.hessianInvoke(className, methodName, null, null);
				return obj;
			}    //捕获下层抛出的异常
			...
			try {
				log.debug("请求的URL地址[" + hessianServer.toString() + "]:spring接口：" + className + "#" + methodName);
				Object obj = hessianServer.hessianInvoke(className, methodName, classTypes, params);
				return obj;
			}     //捕获下层抛出的异常
			catch (CtfoAppException e) {
				throw e;
	...
	public Object execute(HessianServer hessianServer,String beanId,String methodName, Object... params) throws CtfoAppException {
		...
		if (params == null ) {
			...
			try {
				log.debug("请求的URL地址[" + hessianServer.toString() + "]:spring接口：" + beanId + "#" + methodName);
