 ...
 * @since JDK1.6
 */
public interface ThPlatInfosRmi extends RemoteJavaServiceRmi{
	/**
	 * 查询报警督办
	 * @param param
	 * @return
	 */
	@AnnotationName(name = "查询平台信息交互")
