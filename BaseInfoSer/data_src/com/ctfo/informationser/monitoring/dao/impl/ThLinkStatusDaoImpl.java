 ...
 * @since JDK1.6
 */
public class ThLinkStatusDaoImpl extends GenericIbatisAbstract<ThLinkStatus, Long> implements ThLinkStatusDao {

	/*
	 * (non-Javadoc)
	 * 
	 * @see com.ctfo.informationser.monitoring.dao.ThLinkStatusDao#findThLinkStatusByUTC(com.ctfo.local.obj.DynamicSqlParameter)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<ThLinkStatus> findThLinkStatusByUTC(DynamicSqlParameter param) {
		return getSqlMapClientTemplate().queryForList(sqlmapNamespace + ".findThLinkStatusByUTC", param);
	}
