...
public class VechicleExcStatisticService {
	private static final Logger logger = LoggerFactory.getLogger(VechicleExcStatisticService.class);
	...
	public VechicleExcStatisticService(long utc,String vid){
		this.utc = utc;
		this.vid = vid;
		initAnalyser();
	}
