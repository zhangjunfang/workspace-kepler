 ...
 * @author yujch
 */
public class VehicleOverspeedAnalyseDaystatJob extends MyJob {
	
	private String jobName = "VehicleOverspeedAnalyseDaystatJob";
...
/*	@Override
	...
	public int executeJob(JobExecutionContext arg0) throws JobExecutionException {
		...
		VehicleOverspeedAnalyseDaystatJobdetail jobDetail = new VehicleOverspeedAnalyseDaystatJobdetail(dt);
