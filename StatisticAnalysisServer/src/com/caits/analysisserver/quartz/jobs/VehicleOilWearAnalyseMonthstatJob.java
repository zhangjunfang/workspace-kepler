 ...
 * @author yujch
 */
public class VehicleOilWearAnalyseMonthstatJob extends MyJob {
	
	private String jobName = "VehicleOilWearAnalyseMonthstatJob";
...
/*	@Override
	...
	public int executeJob(JobExecutionContext arg0) throws JobExecutionException {
		...
		VehicleOilWearAnalyseMonthstatJobdetail vodJobDetail = new VehicleOilWearAnalyseMonthstatJobdetail(year,previousmonth);
