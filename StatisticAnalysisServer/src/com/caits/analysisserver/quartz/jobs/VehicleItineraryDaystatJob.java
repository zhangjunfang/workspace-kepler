 ...
 * @author yujch
 */
public class VehicleItineraryDaystatJob extends MyJob {
	
	private String jobName = "VehicleItineraryDaystatJob";
...
/*	@Override
	...
	public int executeJob(JobExecutionContext arg0) throws JobExecutionException {
		...
		VehicleItineraryDaystatJobdetail vodJobDetail = new VehicleItineraryDaystatJobdetail(dt);
