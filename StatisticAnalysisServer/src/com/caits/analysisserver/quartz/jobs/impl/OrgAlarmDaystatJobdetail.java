 ...
 * @since JDK1.6
 */
public class OrgAlarmDaystatJobdetail {

	private static final Logger logger = LoggerFactory
			.getLogger(OrgAlarmDaystatJobdetail.class);
	 ...
	 *            当日12点日期时间
	 */
	public OrgAlarmDaystatJobdetail(Date currDay) {
		...
		try {
			...
			if (dbConnection != null) {
				...
				dbPstmt1 = dbConnection
						.prepareStatement(delOrgAlarmDaystatSql);
				dbPstmt1.setLong(1, statDate);
				dbPstmt1.executeUpdate();

				// 查询当日企业车辆运营情况
				dbPstmt2 = dbConnection
						.prepareStatement(queryOrgAlarmDaystatSql);
				...
				.prepareStatement(saveOrgAlarmDaystatSql);
