 ...
 * @author yujch
 */
public class StatServiceMonthsJob extends MyJob {

	private String jobName = "StatServiceMonthsJob";
	...
	public int executeJob(JobExecutionContext arg0) throws JobExecutionException {
		...
		StatServiceMonthsJobdetail vodJobDetail = new StatServiceMonthsJobdetail(year,previousmonth);
