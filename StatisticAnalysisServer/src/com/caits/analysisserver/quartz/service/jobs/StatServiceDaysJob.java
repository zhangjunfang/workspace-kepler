 ...
 * @author yujch
 */
public class StatServiceDaysJob extends MyJob {
	
	private String jobName = "StatServiceDaysJob";
...
/*	@Override
	...
	public int executeJob(JobExecutionContext arg0) throws JobExecutionException {
		...
		StatServiceDaysJobdetail vodJobDetail = new StatServiceDaysJobdetail(dt);
