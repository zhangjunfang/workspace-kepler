 ...
 * @author yujch
 */
public class BackBasedataDaysJob extends MyJob {

	@SuppressWarnings("unused")
	private static Logger logger = LoggerFactory.getLogger(BackBasedataDaysJob.class);
	
	private String jobName = "BackBasedataDaysJob";
...
/*	@Override
	...
	public int executeJob(JobExecutionContext arg0) throws JobExecutionException {
		...
		BackBasedataDaysJobdetail vodJobDetail = new BackBasedataDaysJobdetail(dt);
