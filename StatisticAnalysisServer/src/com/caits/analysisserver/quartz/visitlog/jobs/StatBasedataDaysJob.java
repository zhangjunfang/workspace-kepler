 ...
 * @author yujch
 */
public class StatBasedataDaysJob extends MyJob {

	@SuppressWarnings("unused")
	private static Logger logger = LoggerFactory.getLogger(StatBasedataDaysJob.class);
	
	private String jobName = "StatBasedataDaysJob";
...
/*	@Override
	...
	public int executeJob(JobExecutionContext arg0) throws JobExecutionException {
		...
		StatBasedataDaysJobdetail vodJobDetail = new StatBasedataDaysJobdetail(dt);
