...
public final class Base64_URl {
	...
	/**
	 * 中文转base64编码 （Encoding a string to a string follow the Base64 regular）
	 * 
	 * @param s
	 * @return
	 */
	...
	/**
	 * base64转中文 （Decoding a string to a string follow the Base64 regular.）
	 * 
	 * @param s
	 *            base64 code
	 * @return
     ...
     * @return
     */
    public static String byteToString(String message){
    	return Converser.bytesToHexString(base64DecodeToArray(message));
    }
	...
	public static void main(String[] args) {
		...
		System.err.println("中文转base64:" + s0 + " -->" + s1);
		String s2 = base64Decode(s1);
		System.err.println("base64转中文:" + s1 + " --> " + s2);
