...
public class DateTools {
	...
	public static void main(String argv[]) throws Exception {
		Calendar c = Calendar.getInstance();
		  ...
		  c.set(Calendar.HOUR , Calendar.HOUR + 1 ) ;
	        c.set(Calendar.MINUTE, 0);
	        c.set(Calendar.SECOND, 0);
	        c.set(Calendar.MILLISECOND, 0);
		
		System.out.println("--------当前UTC时间:"+System.currentTimeMillis());
		System.out.println("---函数下一小时UTC时间:"+getNextWholePointTime());
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date date = sdf.parse("2013-10-10 15:00:00");
		System.out.println(" 系统生成下一小时UTC时间:"+date.getTime());
		System.out.println("- -------当前整点时间:"+getCurrentWholePointTime());
		System.out.println("---函数s一小时UTC时间:"+getWholePointTimeOneHourBefore());
		System.out.println("----函数获取下一个整点时间:"+sdf.format(getWholePointTimeOneHourBefore()));  
		
		c.setTimeInMillis(getNextWholePointTime());
	...
	/*****************************************
	 * <li>描        述：获取下一个整点的UTC时间 		</li><br>
	 * <li>时        间：2013-10-10  上午10:27:17	</li><br>
	 * <li>参数： @return			</li><br>
	 * 
	 *****************************************/
	public static long getNextWholePointTime() {
		return getCurrentWholePointTime() + 3600000;
	}
	/*****************************************
	 * <li>描        述：获取前一个整点的UTC时间 		</li><br>
	 * <li>时        间：2013-10-10  上午10:27:17	</li><br>
	 * <li>参数： @return			</li><br>
	 * 
	 *****************************************/
	public static long getWholePointTimeOneHourBefore() {
		return getCurrentWholePointTime() - 3600000;
	}
	/*****************************************
	 * <li>描        述：获取当前整点的UTC时间 		</li><br>
	 * <li>时        间：2013-10-10  上午10:27:17	</li><br>
	 * <li>参数： @return			</li><br>
	 * 
	 *****************************************/
	public static long getCurrentWholePointTime() {
