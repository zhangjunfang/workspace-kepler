...
import com.ctfo.statusservice.model.EngineFaultInfo;
...
//		double lon = lontmp / 1000000;
		...
		long elevtmp = Converser.bytes2int(elevBytes);
		...
		long speedtmp = Converser.bytes2int(speedBytes);
		...
		long direction = Converser.bytes2int(directionBytes);
		...
		engineFaultInfo.setReportTime(time);
	...
	public static String addComma(Object alarmCode) {
		return new StringBuffer().append(",").append(alarmCode).append(",").toString();
	}
	/*****************************************
	 * <li>描        述：包含数字 		</li><br>
	 * <li>时        间：2013-9-25  下午1:16:03	</li><br>
	 * <li>参数： @param string
	 * <li>参数： @return			</li><br>
	 * 
	 *****************************************/
	public boolean contianAlarm(String alarmStr) {
		for(int i = 0 ; i < alarmStr.length(); i++){
			if(Character.isDigit(alarmStr.charAt(i))){
				return true;
			}
		}
		return false;
	...
	/*****************************************
	 * <li>描        述：更换指令标记 		</li><br>
	 * <li>时        间：2013-9-26  下午5:33:01	</li><br>
	 * <li>参数： @param command	指令
	 * <li>参数： @param alarmid	报警编号
	 * <li>参数： @param alarmcode	报警编码
	 * <li>参数： @param status	状态
	 * <li>参数： @return			</li><br>
	 * 
	 *****************************************/
	public static String replaceCommandFlag(String command, String alarmId, String alarmCode, String status) {
