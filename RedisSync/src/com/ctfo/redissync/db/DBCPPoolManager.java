...
public class DBCPPoolManager implements IDbPoolManager {
	...
	public static BasicDataSource getOracleDbPool(String ip, int port, String uid, String user, String pwd) {
		...
		defaultDbPool.setTestOnBorrow(true);
		defaultDbPool.setTestWhileIdle(true);
		defaultDbPool.setMaxWait(500000);
		defaultDbPool.setRemoveAbandoned(true);
		defaultDbPool.setRemoveAbandonedTimeout(180);
		defaultDbPool.setTimeBetweenEvictionRunsMillis(500000);
		defaultDbPool.setMinEvictableIdleTimeMillis(500000);
		defaultDbPool.setValidationQuery("select 1 from dual");
