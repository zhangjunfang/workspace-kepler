...
public class IoHandler extends IoHandlerAdapter {
	...
	public void exceptionCaught(IoSession session, Throwable cause) throws Exception {
		logger.warn("Exception to Data of process!java.nio.charset.UnmappableCharacterException: Input length = 2 (Hexdump:");
	}
		...
		try {
			...
			if (message instanceof String) {
				...
				if(msg.startsWith("LACK")){
					...
					AnalyseServiceInit.getAnalyseServiceThread()[0].addPacket(message.toString());
				}
