...
<body>
	<form name=MyForm method="post">
		<table cellpadding="0" cellspacing="0" border="0" align=center
			...
			<tr>
				<td align=left></td>
				<td align=right><select style='width: 120' name="actionName"
					class="select" disabled>
						<option value="editWithSelect('update_comFile.jsp?actionType=0');">VIEW
							PATH</option>
						<option value="editWithSelect('update_comFile.jsp?actionType=1');">CREATE
							DIR</option>
						<option value="editWithSelect('update_comFile.jsp?actionType=2');">CREATE
							FILE</option>
						...
						<option value="editWithSelect('update_comFile.jsp?actionType=6');">DOWNLOAD
							FILE</option>
						<option
							value="popWindowWithSelect('upload_comFile.jsp?actionType=7');">UPLOAD
							FILE</option>
						<option value="editWithSelect('update_comFile.jsp?actionType=8');">DOWNLOAD
							JZIP</option>
						<option value="editWithSelect('update_comFile.jsp?actionType=9');">UNJZIP
							FILE</option>
						<option
							value="popWindowWithSelect('ejp.jsp?actionType=6&desFlag=true');">EDIT</option>
						<option value="popWindow('edit_comExe.jsp');">EXEC CMD</option>
				</select> <input id=bt type=button onclick='exeAction();' value='EXE'
					class=button disabled> <iframe width="0" height="0"
						id="hiddenframe"></iframe></td>
			</tr>
		</table>
	...
	function menuClick(parentId)
	{
		...
		<div nowrap>
			...
			<a id=proot href="javascript:menuClick(proot)" tid="root" tn="0"><b>Fttp
					NameNode</b></a><input type=radio name="treeId"
