...
public interface FttpLocal {
	...
	public FileResult<byte[]> readByteAsyn(String f, long b, long t,
			boolean locked);
	...
	public FileResult<int[]> readIntAsyn(String f, long b, long t,
			boolean locked);
	...
	public FileResult<Integer> writeIntAsyn(String f, long b, long t,
			int[] its, boolean locked);

	public int writeIntLocked(String f, long b, long t, int[] its)
			throws Throwable;

	public FileResult<Integer> writeByteAsyn(String f, long b, long t,
			byte[] bs, boolean locked);
