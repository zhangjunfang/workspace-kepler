...
public interface CacheLocal {
	/*
	 * public String add(String type, Serializable obj); public Object
	 * get(String type, String keyid); public Object putByKey(String keyId,
	 * String name, Serializable obj); public Object getByKey(String keyid,
	 * String name);
	 */
