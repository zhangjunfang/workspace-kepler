...
public class VehicleMessageBean {
	...
	private Boolean trumpet = false;
	private Boolean abs = false;
	private Boolean brake = false;
	private Boolean retarder = false;
	
	private Boolean overSpeed = false; //超速时长
	
	private Boolean overRpm = false; //超转时长
	
	private Boolean urgentSpeed = false;//急加速时长

	private Boolean urgentLowdown = false; //急减速时长
	
	private Boolean longIdle = false; //超长怠速
	
	private Boolean idleAirCondition = false; //怠速空调
	
	private Boolean gearGlide = false;//空挡滑行
	...
	/**
	 * @param heatUp the heatUp to set
	 */
	...
	/**
	 * @param trumpet the trumpet to set
	 */
	...
	/**
	 * @param retarder the retarder to set
	 */
	...
	/**
	 * @param overRpm the overRpm to set
	 */
	...
	/**
	 * @return the urgentSpeed
	 */
	public Boolean getUrgentSpeed() {
		return urgentSpeed;
	}

	/**
	 * @param urgentSpeed the urgentSpeed to set
	 */
	public void setUrgentSpeed(Boolean urgentSpeed) {
		this.urgentSpeed = urgentSpeed;
	}

	/**
	 * @return the urgentLowdown
	 */
	public Boolean getUrgentLowdown() {
		return urgentLowdown;
	}

	/**
	 * @param urgentLowdown the urgentLowdown to set
	 */
	public void setUrgentLowdown(Boolean urgentLowdown) {
		this.urgentLowdown = urgentLowdown;
	}

	/**
	 * @return the longIdleTime
	 */
	public Boolean getLongIdle() {
		return longIdle;
	}
	 ...
	 */
	public void setLongIdle(Boolean longIdle) {
		this.longIdle = longIdle;
	}

	/**
	 * @return the idleAirCondition
	 */
	public Boolean getIdleAirCondition() {
		return idleAirCondition;
	}

	/**
	 * @param idleAirCondition the idleAirCondition to set
	 */
	public void setIdleAirCondition(Boolean idleAirCondition) {
		this.idleAirCondition = idleAirCondition;
	}

	/**
	 * @return the gearGlide
	 */
	public Boolean getGearGlide() {
		return gearGlide;
	}

	/**
	 * @param gearGlide the gearGlide to set
	 */
	public void setGearGlide(Boolean gearGlide) {
		this.gearGlide = gearGlide;
	}
