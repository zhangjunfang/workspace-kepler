...
CLASS_HOME=""
SERVICE_CLASS="com.ctfo.mileageservice.core.MileageServiceMain"
...
unset CLASSPATH
for i in ${LBS_HOME}/mileageservice/lib/*.jar ; do
  if [ "$CLASSPATH" != "" ]; then
...
LOGBACK=${LBS_HOME}/mileageservice/conf/logback.xml
...
JVM_LOG_DIR="${LBS_HOME}/mileageservice/logs/"
JVM_LOG="${JVM_LOG_DIR}mileageservice-${DATE_STRING}.log"
