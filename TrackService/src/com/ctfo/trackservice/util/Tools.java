...
import com.ctfo.trackservice.model.EngineFaultInfo;
...
//		String s1;
	...
	/*****************************************
	 * <li>描        述：定位状态 		</li><br>
	 * <li>时        间：2013-10-16  下午7:52:05	</li><br>
	 * <li>参数： @param tempStatus
	 * <li>参数： @return			</li><br>
	 * 
	 *****************************************/
	public static boolean isPositioning(String tempStatus) {
		if (tempStatus == null) {
			return false;
		} 
		String status = Long.toBinaryString(Long.parseLong(tempStatus));
		return status.endsWith("11") || status.endsWith("10");
	}
...
//		double lon = lontmp / 1000000;
	...
	/*****************************************
	 * <li>描        述：有报警 		</li><br>
	 * <li>时        间：2013-10-19  下午5:09:03	</li><br>
	 * <li>参数： @param allAlarm			</li><br>
	 * 
	 *****************************************/
	public static boolean onAlarm(CharSequence allAlarm) {
        if (allAlarm == null || allAlarm.length() == 0) {
            return false;
        }
        int sz = allAlarm.length();
        for (int i = 0; i < sz; i++) {
            if (Character.isDigit(allAlarm.charAt(i)) == true) {
                return true;
            }
        }
        return false;
